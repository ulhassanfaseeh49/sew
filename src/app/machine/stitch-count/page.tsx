...
<div className={styles.toolHeader}><span className="category-badge"><span>🔢</span> Machine #445</span><h1>Stitch Count Estimator</h1><p>Total stitches in a project.</p></div>
