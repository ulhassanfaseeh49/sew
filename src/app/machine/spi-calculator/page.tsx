...
<div className={styles.toolHeader}><span className="category-badge"><Hash size={14} strokeWidth={1.5} /> Machine #440</span><h1>SPI Calculator</h1><p>Convert stitch length to stitches per inch.</p></div>
