...
<div className={styles.toolHeader}><span className="category-badge"><ArrowLeftRight size={14} strokeWidth={1.5} /> Machine #439</span><h1>Stitch Width Guide</h1><p>Width for zigzag and decorative stitches.</p></div>
