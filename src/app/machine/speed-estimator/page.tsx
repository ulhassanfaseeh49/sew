...
<div className={styles.toolHeader}><span className="category-badge"><span>⏱</span> Machine #443</span><h1>Speed Estimator</h1><p>Estimate sewing time by seam length.</p></div>
