...
<div className={styles.toolHeader}><span className="category-badge"><Ruler size={14} strokeWidth={1.5} /> Machine #447</span><h1>Seam Guide Tool</h1><p>Seam allowance guide for machines.</p></div>
