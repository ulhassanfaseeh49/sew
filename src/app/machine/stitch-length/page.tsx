...
<div className={styles.toolHeader}><span className="category-badge"><span>📏</span> Machine #438</span><h1>Stitch Length Calculator</h1><p>Stitch length by fabric and application.</p></div>
