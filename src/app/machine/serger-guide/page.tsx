...
<div className={styles.toolHeader}><span className="category-badge"><span>⚙️</span> Machine #448</span><h1>Serger Settings Guide</h1><p>Serger settings by fabric and stitch.</p></div>
