...
import { ClipboardCopy, Printer, Scissors, Wrench } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Wrench size={14} strokeWidth={1.5} /> Machine #446</span><h1>Troubleshooting Tool</h1><p>Fix common sewing machine problems.</p></div>
