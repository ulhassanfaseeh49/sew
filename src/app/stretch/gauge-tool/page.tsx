...
<div className={styles.toolHeader}><span className="category-badge"><Ruler size={14} strokeWidth={1.5} /> Stretch #300</span><h1>Fabric Stretch Gauge</h1><p>Measure stretch accurately.</p></div>
