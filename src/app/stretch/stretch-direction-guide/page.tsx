...
<div className={styles.toolHeader}><span className="category-badge"><ArrowLeftRight size={14} strokeWidth={1.5} /> Stretch #308</span><h1>Two-Way vs Four-Way Stretch</h1><p>Compare stretch directions.</p></div>
