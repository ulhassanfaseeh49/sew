...
<div className={styles.toolHeader}><span className="category-badge"><Scissors size={14} strokeWidth={1.5} /> Stretch #305</span><h1>Knit Stitch Length Guide</h1><p>Stitch types for knit fabrics.</p></div>
