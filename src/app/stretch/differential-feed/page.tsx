...
<div className={styles.toolHeader}><span className="category-badge"><span>⚙️</span> Stretch #306</span><h1>Differential Feed Calculator</h1><p>Serger settings for knits.</p></div>
