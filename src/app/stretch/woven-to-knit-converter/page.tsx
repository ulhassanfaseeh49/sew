...
<div className={styles.toolHeader}><span className="category-badge"><span>🔄</span> Stretch #304</span><h1>Woven to Knit Converter</h1><p>Adapt woven patterns for knits.</p></div>
