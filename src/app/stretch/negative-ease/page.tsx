...
<div className={styles.toolHeader}><span className="category-badge"><span>➖</span> Stretch #302</span><h1>Negative Ease Calculator</h1><p>Negative ease for knit garments.</p></div>
