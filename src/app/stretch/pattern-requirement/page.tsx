...
<div className={styles.toolHeader}><span className="category-badge"><span>✅</span> Stretch #301</span><h1>Stretch Required for Pattern</h1><p>Does your fabric have enough stretch?</p></div>
