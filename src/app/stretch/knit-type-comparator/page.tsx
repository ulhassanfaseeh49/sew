...
<div className={styles.toolHeader}><span className="category-badge"><span>⚖️</span> Stretch #303</span><h1>Knit Type Comparator</h1><p>Jersey vs interlock vs rib.</p></div>
