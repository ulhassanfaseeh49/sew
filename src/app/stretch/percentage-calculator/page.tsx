...
<div className={styles.toolHeader}><span className="category-badge"><span>📊</span> Stretch #299</span><h1>Stretch Percentage Calculator</h1><p>Calculate fabric stretch percentage.</p></div>
