...
<div className={styles.toolHeader}><span className="category-badge"><Shirt size={14} strokeWidth={1.5} /> Costume #334</span><h1>Corset Fabric Yardage</h1><p>Fabric for corsets.</p></div>
