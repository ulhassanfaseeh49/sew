...
<div className={styles.toolHeader}><span className="category-badge"><span>🛡️</span> Costume #344</span><h1>Armor Pattern Scaling</h1><p>Scale armor patterns to your body.</p></div>
