...
const sizes = [{"k":"small","n":"Small Bustle","yd":1},{"k":"med","n":"Medium Bustle","yd":1.5},{"k":"large","n":"Large Victorian","yd":2.5},{"k":"lobster","n":"Lobster Tail","yd":3}];

export default function Page() {
    const [sizeKey, setSizeKey] = useState(sizes[0].k);
    const [qty, setQty] = useState(1);
    const [activeFaq, setActiveFaq] = useState<number | null>(null);
    const faqItems = [{"q":"How does a bustle work?","a":"A bustle creates volume at the back of a skirt using a pad, cage, or gathered fabric. Victorian bustles used wire cages. Modern bustles use gathered fabric or tied-up trains."}];
    ...
    return (<div className="container"><Breadcrumb items={[{ label: "Costume", href: "/costume" }, { label: "Bustle Calculator" }]} />
        <div className="calculator-layout"><div className="calculator-main">
            <div className={styles.toolHeader}><span className="category-badge"><Wand2 size={14} /> Costume #349</span><h1>Bustle Calculator</h1><p>Calculate fabric for bustles.</p></div>
