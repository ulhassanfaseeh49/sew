...
<div className={styles.toolHeader}><span className="category-badge"><Drama size={14} strokeWidth={1.5} /> Costume #333</span><h1>Costume Yardage Estimator</h1><p>Yardage by costume type.</p></div>
