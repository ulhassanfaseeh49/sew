...
export default function Page() {
    ...
    return (<div className="container"><Breadcrumb items={[{ label: "Costume", href: "/costume" }, { label: "Stage Quick Estimator" }]} />
        <div className="calculator-layout"><div className="calculator-main">
            <div className={styles.toolHeader}><span className="category-badge"><span>🎭</span> Costume #350</span><h1>Stage Costume Quick Estimator</h1><p>Quick yardage for theatrical costumes.</p></div>
