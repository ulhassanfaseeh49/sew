...
<div className={styles.toolHeader}><span className="category-badge"><span>📄</span> Skirt #361</span><h1>Pleated Skirt Calculator</h1><p>Fabric for knife, box, and accordion pleats.</p></div>
