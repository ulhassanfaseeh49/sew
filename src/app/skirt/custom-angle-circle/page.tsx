...
<div className={styles.toolHeader}><span className="category-badge"><Ruler size={14} strokeWidth={1.5} /> Skirt #355</span><h1>Custom Angle Circle Skirt</h1><p>Any angle circle skirt.</p></div>
