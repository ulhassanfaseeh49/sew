...
export default function FullCirclePage() {
 ...
 <div style={{ fontSize: 12, color: "var(--color-text-tertiary)", marginBottom: 6 }}>Measure around your natural waist (smallest part) — or hips if the skirt sits lower.
 </div>
 ...
 <div style={{ fontSize: 12, color: "var(--color-text-tertiary)", marginBottom: 6 }}>Measure from waist to desired hem. Choose a style or enter custom.
 </div>
 <div style={{ display: "flex", flexWrap: "wrap", gap: 4, marginBottom: 8 }}>
 ...
 <div style={{ fontSize: 10, color: "var(--color-text-tertiary)", marginTop: 4 }}>Approximate lengths for 5′4″ (163 cm). Adjust for your height.
 </div>
 </div>
 ...
 onClick={() =>setShowRef(!showRef)}>Circle Skirt Reference Chart
 ...
 <div style={{ fontSize: 9, marginTop: 4, color: "var(--color-text-tertiary)" }}>Yardage for 44&quot; fabric with {toFrac(hemAllow)}&quot; hem. <span style={{ color: "hsl(150,50%,35%)" }}>Green = fits one-piece</span>, <span style={{ color: "hsl(0,50%,45%)" }}>Red = needs back seam</span>. Click any cell to fill calculator.
 </div>
 </div>
 )}
 </div>
 ...
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
 onClick={() =>setShowMath(!showMath)}>The Circle Skirt Formula Explained
 ...
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
 onClick={() =>setShowStyles(!showStyles)}>Circle Skirt Styles — Fullness Comparison
 ...
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
 onClick={() =>setShowProblems(!showProblems)}>Common Problems &amp; Solutions
