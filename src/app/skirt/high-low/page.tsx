...
<div className={styles.toolHeader}><span className="category-badge"><TrendingUp size={14} strokeWidth={1.5} /> Skirt #366</span><h1>High-Low Hem Skirt</h1><p>Asymmetric hem skirt.</p></div>
