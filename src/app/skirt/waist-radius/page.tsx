...
<div className={styles.toolHeader}><span className="category-badge"><Ruler size={14} strokeWidth={1.5} /> Skirt #358</span><h1>Waist Radius Calculator</h1><p>Radius from waist measurement.</p></div>
