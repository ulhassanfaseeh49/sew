...
import { ClipboardCopy, Printer, Recycle, Scale } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Scale size={14} strokeWidth={1.5} /> Eco #460</span><h1>Make vs Buy Calculator</h1><p>Environmental impact comparison.</p></div>
