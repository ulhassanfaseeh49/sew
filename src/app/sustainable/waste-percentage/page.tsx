...
<div className={styles.toolHeader}><span className="category-badge"><span>♻️</span> Eco #450</span><h1>Waste Percentage Calculator</h1><p>Calculate fabric waste percentage.</p></div>
