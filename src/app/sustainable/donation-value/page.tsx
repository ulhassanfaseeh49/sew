...
import { ClipboardCopy, Gift, Printer, Recycle } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Gift size={14} strokeWidth={1.5} /> Eco #458</span><h1>Donation Value Calculator</h1><p>Value fabric for donations/swaps.</p></div>
