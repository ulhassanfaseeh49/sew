...
<div className={styles.toolHeader}><span className="category-badge"><span>✂️</span> Eco #451</span><h1>Zero-Waste Cutting Guide</h1><p>Zero-waste cutting techniques.</p></div>
