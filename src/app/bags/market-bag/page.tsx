...
import { ClipboardCopy, Printer, ShoppingBag, ShoppingCart } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><ShoppingCart size={14} strokeWidth={1.5} /> Bag #376</span><h1>Market/Grocery Bag</h1><p>Reusable grocery bags.</p></div>
