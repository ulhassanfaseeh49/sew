...
<div className={styles.toolHeader}><span className="category-badge"><span>📋</span> Bag #369</span><h1>Bag Interfacing Calculator</h1><p>Interfacing for structured bags.</p></div>
