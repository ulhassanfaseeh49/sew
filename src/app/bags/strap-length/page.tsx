...
<div className={styles.toolHeader}><span className="category-badge"><span>📏</span> Bag #370</span><h1>Strap Length Calculator</h1><p>Strap for shoulder, crossbody, and handles.</p></div>
