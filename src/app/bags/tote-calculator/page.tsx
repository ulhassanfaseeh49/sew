...
<div className={styles.toolHeader}><span className="category-badge"><span>👜</span> Bag #367</span><h1>Tote Bag Calculator</h1><p>Fabric for tote bags by dimensions.</p></div>
