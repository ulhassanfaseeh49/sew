...
<div className={styles.toolHeader}><span className="category-badge"><Baby size={14} strokeWidth={1.5} /> Baby #387</span><h1>Receiving Blanket</h1><p>Fabric for receiving blankets.</p></div>
