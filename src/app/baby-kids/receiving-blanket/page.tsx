...
export default function Page() {
 ...
 {fabricType === "flannel" && (
 <div style={{ fontSize: 10, color: "hsl(40,70%,35%)", marginTop: 4 }}>⚠ Flannel shrinks 10-15%. Extra added automatically. Pre-wash in hot water before cutting.</div>
 )}
 </div>
 ...
 {/* BULK TABLE */}
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() =>setShowBulk(!showBulk)}>Bulk / Donation Planning
 ...
 {/* EDUCATIONAL */}
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() =>setShowEdu(!showEdu)}>Fabric Guide for Baby Blankets
