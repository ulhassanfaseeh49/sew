...
import { Baby, ClipboardCopy, Drama, Printer } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Drama size={14} strokeWidth={1.5} /> Baby #394</span><h1>Kids Costume Size</h1><p>Fabric for children costumes.</p></div>
