...
export default function Page() {
 ...
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() =>setShowBulk(!showBulk)}>Bulk / Gift Set Planning <ChevronDown size={14} style={{ transform: showBulk ? "rotate(180deg)" : "none", transition: ".2s" }} />
 </button>
 {showBulk && (
