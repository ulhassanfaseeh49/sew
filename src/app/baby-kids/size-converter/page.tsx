...
import { Baby, ClipboardCopy, Printer, Ruler } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Ruler size={14} strokeWidth={1.5} /> Baby #389</span><h1>Children Size Converter</h1><p>US/UK/EU size conversion.</p></div>
