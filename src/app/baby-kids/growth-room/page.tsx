...
export default function Page() {
 ...
 <div style={{ fontSize: 10, color: "var(--color-text-tertiary)", marginTop: 8 }}>Growth rate: {calc.rate.hPerYr}&quot;/yr height at this age. Estimated useful life: ~{calc.usefulMonths} months.
 </div>
 </div>
 ...
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() =>setShowEdu(!showEdu)}>Smart Design for Growing Kids
