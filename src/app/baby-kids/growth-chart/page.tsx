        ...
        <div className="container">
            ...
            <div className="calculator-layout">
                <div className="calculator-main">
                    ...
                    <div style={{ padding: 10, background: "hsl(40,35%,95%)", borderRadius: 8, fontSize: 12, marginBottom: 10, color: "hsl(40,60%,30%)", fontWeight: 600, borderLeft: "4px solid hsl(40,60%,50%)" }}>
                        💡 These are average (50th percentile) measurements. Always measure the actual child when possible — children vary significantly.
                    </div>
