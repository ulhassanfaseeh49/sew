...
import { Baby, BarChart3, ClipboardCopy, Printer } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><BarChart3 size={14} strokeWidth={1.5} /> Baby #399</span><h1>Growth Chart by Age</h1><p>Body measurements by age.</p></div>
