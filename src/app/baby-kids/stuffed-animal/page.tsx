...
import { Baby, ClipboardCopy, Gift, Printer } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Gift size={14} strokeWidth={1.5} /> Baby #398</span><h1>Stuffed Animal Size</h1><p>Fabric for plush toys.</p></div>
