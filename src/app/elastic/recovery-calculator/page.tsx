...
<div className={styles.toolHeader}><span className="category-badge"><BarChart3 size={14} strokeWidth={1.5} /> Elastic #294</span><h1>Elastic Recovery Calculator</h1><p>Stretch and recovery rates.</p></div>
