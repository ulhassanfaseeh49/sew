...
<div className={styles.toolHeader}><span className="category-badge"><span>📏</span> Elastic #293</span><h1>Elastic Casing Width</h1><p>Casing width from elastic width.</p></div>
