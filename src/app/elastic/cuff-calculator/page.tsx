...
import { ClipboardCopy, Printer, RefreshCw } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><RefreshCw size={14} strokeWidth={1.5} /> Elastic #291</span><h1>Cuff Elastic Calculator</h1><p>Elastic for sleeve and pant cuffs.</p></div>
