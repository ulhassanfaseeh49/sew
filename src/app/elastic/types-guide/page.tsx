...
<div className={styles.toolHeader}><span className="category-badge"><BookOpen size={14} strokeWidth={1.5} /> Elastic #297</span><h1>Elastic Types Guide</h1><p>Guide to elastic types and applications.</p></div>
