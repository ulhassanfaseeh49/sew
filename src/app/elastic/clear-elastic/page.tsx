...
<div className={styles.toolHeader}><span className="category-badge"><Search size={14} strokeWidth={1.5} /> Elastic #296</span><h1>Clear Elastic for Knits</h1><p>Clear elastic for stabilizing knit seams.</p></div>
