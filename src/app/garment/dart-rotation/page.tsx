...
<div className={styles.toolHeader}><span className="category-badge"><span>🔄</span> Garment #203</span><h1>Dart Rotation Tool</h1><p>Guide for rotating darts to different positions.</p></div>
