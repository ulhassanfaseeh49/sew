...
<div className={styles.toolHeader}><span className="category-badge"><span>📏</span> Garment #216</span><h1>Waistband Calculator</h1><p>Waistband length and width.</p></div>
