...
<div className={styles.toolHeader}><span className="category-badge"><span>〰️</span> Garment #207</span><h1>Gather Ratio Calculator</h1><p>Fabric needed for gathering.</p></div>
