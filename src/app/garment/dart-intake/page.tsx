...
<div className={styles.toolHeader}><span className="category-badge"><span>📏</span> Garment #202</span><h1>Dart Intake Calculator</h1><p>How much fabric a dart takes in.</p></div>
