...
<div className={styles.toolHeader}><span className="category-badge"><span>📋</span> Garment #219</span><h1>Placket Calculator</h1><p>Placket dimensions for various types.</p></div>
