...
<div className={styles.toolHeader}><span className="category-badge"><span>👖</span> Garment #225</span><h1>Pocket Placement Tool</h1><p>Pocket placement positions.</p></div>
