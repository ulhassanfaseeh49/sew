...
<div className={styles.toolHeader}><span className="category-badge"><Ribbon size={14} strokeWidth={1.5} /> Garment #208</span><h1>Ruffle Fullness Calculator</h1><p>Fabric strip length for ruffles.</p></div>
