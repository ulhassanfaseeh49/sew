...
<div className={styles.toolHeader}><span className="category-badge"><Ruler size={14} strokeWidth={1.5} /> Garment #210</span><h1>Hem Allowance Calculator</h1><p>Hem allowance by hem type.</p></div>
