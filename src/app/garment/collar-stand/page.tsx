...
<div className={styles.toolHeader}><span className="category-badge"><span>👔</span> Garment #220</span><h1>Collar Stand Calculator</h1><p>Collar stand dimensions by collar type.</p></div>
