...
export default function Page() {
    ...
    const easeStyles = [{ name: 'Very fitted', bust: 0, waist: 0, hip: 0, desc: 'Body skimming' }, { name: 'Fitted', bust: 2.5, waist: 1, hip: 2, desc: 'Close but comfortable' }, { name: 'Semi-fitted', bust: 4, waist: 2, hip: 3, desc: 'Defined shape' }, { name: 'Loose', bust: 6, waist: 4, hip: 5, desc: 'Relaxed' }]; const s = easeStyles[vals.style] || easeStyles[1];
