...
<div className={styles.toolHeader}><span className="category-badge"><span>📖</span> Garment #227</span><h1>Ease by Style Guide</h1><p>Standard ease by garment style.</p></div>
