...
<div className={styles.toolHeader}><span className="category-badge"><Scissors size={14} strokeWidth={1.5} /> Garment #209</span><h1>Smocking Yardage</h1><p>Fabric width for smocking.</p></div>
