...
<div className={styles.toolHeader}><span className="category-badge"><span>📐</span> Garment #201</span><h1>Dart Calculator</h1><p>Calculate dart width, length, and intake.</p></div>
