...
<div className={styles.toolHeader}><span className="category-badge"><span>👁️</span> Garment #214</span><h1>Blind Hem Calculator</h1><p>Fold depths for invisible blind hems.</p></div>
