...
<div className={styles.toolHeader}><span className="category-badge"><span>📊</span> Garment #211</span><h1>Hem Depth Comparator</h1><p>Compare hem depths and visual effect.</p></div>
