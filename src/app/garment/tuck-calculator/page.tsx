...
<div className={styles.toolHeader}><span className="category-badge"><span>📐</span> Garment #229</span><h1>Tuck Calculator</h1><p>Calculate tuck size, spacing, and fabric needed.</p></div>
