...
<div className={styles.toolHeader}><span className="category-badge"><span>🔄</span> Garment #224</span><h1>Sleeve Style Converter</h1><p>Convert between set-in and raglan sleeves.</p></div>
