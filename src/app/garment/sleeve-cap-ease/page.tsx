...
<div className={styles.toolHeader}><span className="category-badge"><Ruler size={14} strokeWidth={1.5} /> Garment #223</span><h1>Sleeve Cap Ease</h1><p>Sleeve cap ease calculation.</p></div>
