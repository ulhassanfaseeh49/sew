...
<div className={styles.toolHeader}><span className="category-badge"><span>↗️</span> Garment #228</span><h1>Fabric Grain Line Guide</h1><p>Guide for straight grain, cross grain, bias.</p></div>
