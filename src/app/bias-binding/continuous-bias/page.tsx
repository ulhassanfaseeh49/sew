...
import { ClipboardCopy, Printer, RefreshCw, Ribbon } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><RefreshCw size={14} strokeWidth={1.5} /> Bias #282</span><h1>Continuous Bias Strip</h1><p>Bias tape from a fabric square.</p></div>
