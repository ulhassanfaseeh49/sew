...
import { ClipboardCopy, Link, Printer, Ribbon } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Link size={14} strokeWidth={1.5} /> Bias #285</span><h1>Bias Tape Joining</h1><p>Extra length for joins.</p></div>
