...
<div className={styles.toolHeader}><span className="category-badge"><span></span> Bias #289</span><h1>Piping from Bias Tape</h1><p>Bias tape width for piping cord.</p></div>
