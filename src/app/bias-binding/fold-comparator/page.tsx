...
import { ClipboardCopy, Printer, Ribbon, Scale } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Scale size={14} strokeWidth={1.5} /> Bias #284</span><h1>Single vs Double Fold</h1><p>Compare fold types.</p></div>
