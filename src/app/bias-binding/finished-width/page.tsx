...
<div className={styles.toolHeader}><span className="category-badge"><span>📊</span> Bias #286</span><h1>Binding Width Calculator</h1><p>Cut width to finished width.</p></div>
