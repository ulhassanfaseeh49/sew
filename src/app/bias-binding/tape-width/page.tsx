...
<div className={styles.toolHeader}><span className="category-badge"><Ruler size={14} strokeWidth={1.5} /> Bias #280</span><h1>Bias Tape Width Calculator</h1><p>Cutting width for desired finished width.</p></div>
