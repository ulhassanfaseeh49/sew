            ...
            <div className="calculator-layout">
                <div className="calculator-main">
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        ...
                        <div style={{ marginTop: 8, padding: "8px 12px", background: "hsl(150,40%,95%)", borderRadius: "var(--radius-md)", fontSize: 13, fontWeight: 600, color: "hsl(150,50%,30%)" }}>
                            Total: {totalSq} squares at 5&quot; × 5&quot; (finishes at {FINISHED}&quot; each)
                        </div>
                    </div>
                        ...
                        {project === "hst" && (
                            <div className={`calculator-results ${styles.results}`}>
                                ...
                                <div style={{ marginTop: 8, fontSize: 12, color: "var(--color-text-tertiary)" }}>
                                    ...
                                    HST cutting: draw diagonal line on lighter square, sew ¼&quot; on each side, cut on line, press, trim to 4½&quot; unfinished.
                                </div>
                            </div>
                        )}
                        ...
                        {project === "fourpatch" && (
                            <div className={`calculator-results ${styles.results}`}>
                                ...
                                <div style={{ marginTop: 6, fontSize: 12, color: "var(--color-text-tertiary)" }}>
                                    Nine-patch option: {results.subCutSq} squares ÷ 9 = {Math.floor(results.subCutSq / 9)} nine-patch blocks at 6&quot; finished ({results.subCutSq % 9 > 0 ? `${results.subCutSq % 9} leftover squares` : "none leftover"})
                                </div>
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
                            ...
                            📊 Charm Packs Needed for Standard Quilt Sizes <ChevronDown size={14} style={{ transform: showRef ? "rotate(180deg)" : "none", transition: "0.2s" }} />
                        </button>
                        {showRef && (
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
                            ...
                            📚 The 5&quot; to 4½&quot; Mystery — Why Charm Squares Shrink <ChevronDown size={14} style={{ transform: showEdu ? "rotate(180deg)" : "none", transition: "0.2s" }} />
                        </button>
                        {showEdu && (
