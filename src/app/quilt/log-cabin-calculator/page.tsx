        ...
        <div className="container">
            ...
            <div className="calculator-layout">
                <div className="calculator-main">
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        ...
                        <div style={{ marginTop: 10, padding: 10, borderRadius: 6, background: sizeMatch ? "hsl(150,25%,95%)" : "hsl(40,40%,95%)", border: `1px solid ${sizeMatch ? "hsl(150,40%,70%)" : "hsl(40,50%,70%)"}` }}>
                            <div style={{ fontSize: 13, fontWeight: 700 }}>
                                Resulting block: <span style={{ color: sizeMatch ? "hsl(150,60%,30%)" : "hsl(30,70%,40%)", fontSize: 16 }}>{blockFin}&quot; × {blockFin}&quot;</span> finished
                            ...
                            <div style={{ fontSize: 11, marginTop: 4, color: "var(--color-text-secondary)" }}>
                                Center: {toFrac(centerCut)}&quot; × {toFrac(centerCut)}&quot; cut • Strips: {toFrac(stripCut)}&quot; wide cut • {strips.length} strips per block • {numRounds} rounds
                            </div>
                    ...
                    {/* ═══ ACHIEVABLE SIZES ═══ */}
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() => setShowCombos(!showCombos)}>
                            📐 Achievable Combinations for {finishedSize}&quot; Block ({combos.length} found)
                        ...
                        {showJelly && (
                            <div style={{ marginTop: 10, fontSize: 12, lineHeight: 2 }}>
                                ...
                                <div style={{ padding: 8, background: "hsl(0,0%,97%)", borderRadius: 6 }}>
                                    <strong>For {numBlocks} blocks:</strong><br />
                                    Dark jelly roll strips needed: <strong>{analysis.jellyDarkTotal}</strong><br />
                                    Light jelly roll strips needed: <strong>{analysis.jellyLightTotal}</strong><br />
                                    Total: <strong>{analysis.jellyDarkTotal + analysis.jellyLightTotal} strips</strong><br />
                    ...
                    {blockStyle === "standard" && (
                        <div className={`glass-card ${styles.calculatorCard}`}>
                            <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() => setShowLayouts(!showLayouts)}>
                                🎨 Log Cabin Layout Arrangements
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() => setShowEdu(!showEdu)}>
                            📚 Understanding Log Cabin Blocks
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() => setShowTrouble(!showTrouble)}>
                            🔧 Troubleshooting Log Cabin Blocks
