            ...
            <div className="calculator-layout">
                <div className="calculator-main">
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        ...
                        <div className="calculator-form-row">
                            <div className="input-group">
                                ...
                                {!calc.isEven && <div style={{ marginTop: 4, fontSize: 10, color: "hsl(40,70%,45%)" }}>⚠️ Odd sizes create non-standard HSTs.</div>}
                            </div>
                            <div className="input-group">
                        ...
                        <div style={{ display: "flex", gap: 12, flexWrap: "wrap", alignItems: "flex-start" }}>
                            <div style={{ flex: 1, minWidth: 200 }}>
                                ...
                                <div style={{ marginTop: 8, padding: 8, background: "hsl(280,12%,97%)", borderRadius: 6, fontSize: 12 }}>
                                    ...
                                    Color A (dark): <strong>{calc.sqPerBlock} square{calc.sqPerBlock > 1 ? "s" : ""}</strong> at {toF(calc.cutSq)}<br />
                                    Color B (light): <strong>{calc.sqPerBlock} square{calc.sqPerBlock > 1 ? "s" : ""}</strong> at {toF(calc.cutSq)}
                                </div>
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`} style={{ borderLeft: "4px solid hsl(40,70%,50%)", background: "hsl(40,20%,98%)" }}>
                        <h2 className={styles.calcTitle}>⚠️ Critical: HST Orientation</h2>
                        <div style={{ fontSize: 12, lineHeight: 2 }}>
                            ...
                            <div style={{ fontFamily: "monospace", fontSize: 12, padding: 10, background: "hsl(0,0%,97%)", borderRadius: 6, lineHeight: 1.8, marginBottom: 8 }}>
                                Clockwise arrangement:<br />
                                ┌─────┬─────┐<br />
                                │ ■ ╲ │ ╱ ■ │ &nbsp;← dark triangles<br />
                                │ &nbsp;╲□│□╱ &nbsp;│ &nbsp;&nbsp;&nbsp; point to center<br />
                                ├─────┼─────┤<br />
                    ...
                    {/* ═══ ASSEMBLY ═══ */}
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() => setShowAssembly(!showAssembly)}>
                    ...
                    {/* ═══ TWIRL ═══ */}
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() => setShowTwirl(!showTwirl)}>
                            🌀 Twirl Pressing Technique
                        ...
                        {showTwirl && (
                            <div style={{ marginTop: 10, fontSize: 12, lineHeight: 2, color: "var(--color-text-secondary)" }}>
                                <div style={{ padding: 8, background: "hsl(280,10%,97%)", borderRadius: 6, marginBottom: 8 }}>
                                    The center of a pinwheel has <strong>8 seam allowances</strong> meeting at one point. Without special pressing, this creates a hard, bulky bump.
                                </div>
                                {[
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        ...
                        {showYardage && (
                            <div style={{ marginTop: 10, fontSize: 12, lineHeight: 1.9 }}>
                                ...
                                <div style={{ padding: 8, background: "hsl(0,0%,97%)", borderRadius: 6, textAlign: "center", fontWeight: 700 }}>
                                    Total: {toFrac(yard.buyA + yard.buyB)} yards
                                </div>
                                {method === "2at" && (
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() => setShowDouble(!showDouble)}>
                            🌀🌀 Double Pinwheel Calculator
                            <ChevronDown size={14} style={{ transform: showDouble ? "rotate(180deg)" : "none", transition: ".2s" }} />
                        </button>
                        {showDouble && (
                            <div style={{ marginTop: 10, fontSize: 12, lineHeight: 1.9 }}>
                                <div style={{ padding: 8, background: "hsl(280,10%,97%)", borderRadius: 6, marginBottom: 8 }}>
                                    Two nested spinning elements: large outer blades + small inner blades.
                                </div>
                                ...
                                {finBlock % 4 !== 0 && <div style={{ marginTop: 6, fontSize: 11, color: "hsl(40,70%,45%)" }}>⚠️ For best results, block size should be divisible by 4 for equal inner/outer HSTs.</div>}
                            </div>
                        )}
                    </div>
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() => setShowTrouble(!showTrouble)}>
                            🔧 Troubleshooting Pinwheel Blocks
