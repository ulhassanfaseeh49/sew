...
<div className={styles.toolHeader}><span className="category-badge"><Ruler size={14} strokeWidth={1.5} /> Quilt #129</span><h1>Quilt Size Calculator</h1><p>Calculate finished quilt size from blocks, sashing, and borders.</p></div>
