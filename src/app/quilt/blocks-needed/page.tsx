...
<div className={styles.toolHeader}><span className="category-badge"><span>🔢</span> Quilt #130</span><h1>Blocks Needed Calculator</h1><p>How many blocks for a specific quilt size.</p></div>
