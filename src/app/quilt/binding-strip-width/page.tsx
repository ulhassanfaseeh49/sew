                ...
                <div className="calculator-main">
                                ...
                                {mode === "B" && result.finWidth > 0 && (
                                    <div style={{ background: result.finWidth >= 0.25 ? "hsl(140,50%,95%)" : "hsl(0,50%,95%)", borderRadius: "var(--radius-md)", padding: 14, marginTop: 10, fontSize: 13, lineHeight: 1.8 }}>
                                        ...
                                        <div style={{ marginTop: 4 }}>
                                            Your {toFrac(result.cutWidth)}&quot; strips give {toFrac(result.finWidth)}&quot; finished binding.
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
                            ...
                            📐 Full Width Reference Table <ChevronDown size={14} style={{ transform: showRef ? "rotate(180deg)" : "none", transition: "0.2s" }} />
                        </button>
                        {showRef && (
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
                            ...
                            🧪 Binding Strip Test Method <ChevronDown size={14} style={{ transform: showTestGuide ? "rotate(180deg)" : "none", transition: "0.2s" }} />
                        </button>
                        {showTestGuide && (
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
                            ...
                            📚 Why 2.5&quot; Strips Don&apos;t Make 2.5&quot; Binding <ChevronDown size={14} style={{ transform: showEdu ? "rotate(180deg)" : "none", transition: "0.2s" }} />
                        </button>
                        {showEdu && (
                            <div style={{ marginTop: 12, fontSize: 14, lineHeight: 1.8, color: "var(--color-text-secondary)" }}>
                    ...
                    <div className="glass-card" style={{ padding: "var(--space-5)", marginBottom: "var(--space-4)" }}>
                        ...
                        <div style={{ fontSize: 13, color: "var(--color-text-secondary)", lineHeight: 1.8, fontFamily: "var(--font-mono, monospace)" }}>
                            <div style={{ marginBottom: 8 }}>
                                <strong>Double-fold:</strong><br />
                                Cut = (Fin × 4) + (SA × 2)
                            </div>
                            <div>
                                <strong>Single-fold:</strong><br />
                                Cut = (Fin × 2) + SA + SA
                            </div>
                        </div>
                    </div>
