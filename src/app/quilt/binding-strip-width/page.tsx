...
<div className={styles.toolHeader}><span className="category-badge"><span>📏</span> Quilt #139</span><h1>Binding Strip Width</h1><p>Cut width for desired finished binding.</p></div>
