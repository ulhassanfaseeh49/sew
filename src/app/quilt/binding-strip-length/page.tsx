                ...
                <div className="calculator-main">
                                ...
                                <div className="calculator-form-row">
                                    <div className="input-group">
                                        ...
                                        <span style={{ fontSize: 11, color: "var(--color-text-tertiary)" }}>
                                            Default: 3&quot; × 4 corners = 12&quot;{corners !== 4 ? ` (scaled to ${effectiveCA}" for ${corners} corners)` : ""}
                                        </span>
                                    </div>
                                    <div className="input-group">
                    ...
                    {result && (<>
                        <div className={`calculator-results ${styles.results}`}>
                            ...
                            {/* Formula */}
                            <div style={{ background: "var(--color-bg-secondary)", borderRadius: "var(--radius-md)", padding: 12, marginTop: 10, fontSize: 13, fontFamily: "var(--font-mono, monospace)" }}>
                                Total = Perimeter + Corners + Join + Safety
                                <br />
                                Total = {perimeter}&quot; + {effectiveCA}&quot; + {ja}&quot; + {sm}&quot; = <strong>{result.totalLen}&quot;</strong>
                            </div>
                        </div>
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
                            ...
                            📐 Quick Reference — Standard Quilt Sizes <ChevronDown size={14} style={{ transform: showRef ? "rotate(180deg)" : "none", transition: "0.2s" }} />
                        </button>
                        {showRef && (
                            <div className={styles.tableWrap} style={{ marginTop: 12 }}>
                                ...
                                <div style={{ fontSize: 12, color: "var(--color-text-tertiary)", marginTop: 6 }}>
                                    Based on standard allowances: 12&quot; corners + 15&quot; join + 12&quot; safety = +39&quot;.
                                </div>
                            </div>
                        )}
                    </div>
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
                            ...
                            📚 Understanding Binding Strip Length <ChevronDown size={14} style={{ transform: showEdu ? "rotate(180deg)" : "none", transition: "0.2s" }} />
                        </button>
                        {showEdu && (
                ...
                <aside className="calculator-sidebar">
                    <div className="glass-card" style={{ padding: "var(--space-5)", marginBottom: "var(--space-4)" }}>
                        ...
                        <div style={{ fontSize: 13, color: "var(--color-text-secondary)", lineHeight: 1.8 }}>
                            <div style={{ fontFamily: "var(--font-mono, monospace)", marginBottom: 8 }}>
                                Total = Perimeter<br />
                                &nbsp; + Corner (3&quot;×4)<br />
                                &nbsp; + Join (12-18&quot;)<br />
                                &nbsp; + Safety (6-18&quot;)
