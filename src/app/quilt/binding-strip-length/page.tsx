...
const w2=parseFloat(qw)||60;const h2=parseFloat(qh)||80;const perim=(w2+h2)*2;const joins=Math.ceil(perim/42)*4;const total=perim+joins+12;const hasResult=true;const resultValue=total+"\"";const resultLabel="total binding length";
