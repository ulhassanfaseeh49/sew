...
export default function Page() {
 ...
 {!calc.isDivisible && <div style={{ padding: 6, background: "hsl(40,40%,95%)", borderRadius: 6, fontSize: 11, marginBottom: 8 }}>⚠ Block size {toFracIn(calc.finBlk)} does not divide evenly by 3. Squares will be {toFracIn(calc.finSq)} finished.</div>}
 ...
 <strong>Per block:</strong><br />Color A (dark): <strong>5 squares</strong>at {toFracIn(calc.cutSq)}<br />Color B (light): <strong>4 squares</strong>at {toFracIn(calc.cutSq)}
 </div>
 </div>
 ...
 {/* ═══ STRIP PIECING ═══ */}
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() =>setShowStrip(!showStrip)}>Strip Piecing Instructions (Step-by-Step)
 ...
 <div style={{ textAlign: "center", fontSize: 11, marginTop: 4, fontWeight: 600, color: "hsl(150,50%,35%)" }}>Saves {yard.indivCuts - yard.stripCuts - yard.subCuts} cuts ({Math.round((1 - (yard.stripCuts + yard.subCuts) / yard.indivCuts) * 100)}% fewer)
 </div>
 </div>
 </div>
 )}
 ...
 {/* ═══ YARDAGE ═══ */}
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() =>setShowYardage(!showYardage)}>Yardage Calculator for {blockCount} Blocks
 ...
 <div style={{ padding: 8, background: "hsl(0,0%,97%)", borderRadius: 6, textAlign: "center", fontWeight: 700, fontSize: 14 }}>Total: {toFrac(yard.darkBuy + yard.lightBuy)} yards ({(yard.darkBuy + yard.lightBuy).toFixed(2)} yd)
 </div>
 ...
 {/* ═══ SCRAPPY ═══ */}
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() =>setShowScrappy(!showScrappy)}>Scrappy Nine-Patch Planner
 ...
 {showDouble && (
 <div style={{ marginTop: 10, fontSize: 12, lineHeight: 1.9 }}>
 <div style={{ padding: 10, background: "hsl(260,12%,97%)", borderRadius: 8, marginBottom: 8 }}>A double nine-patch: 5 of the 9 inner squares are themselves mini nine-patches; 4 are plain squares.
 </div>
 <div className={styles.resultDetails}>
 ...
 {/* ═══ TROUBLESHOOTING ═══ */}
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() =>setShowTrouble(!showTrouble)}>Troubleshooting Nine-Patch Blocks
 ...
 {/* ═══ EDUCATIONAL ═══ */}
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() =>setShowEdu(!showEdu)}>Understanding Nine-Patch Blocks
 ...
 <div style={{ fontSize: 11, padding: 8, background: "hsl(0,0%,96%)", borderRadius: 6, fontFamily: "monospace", lineHeight: 2 }}>Square = Block ÷ 3<br />Cut = Square + ½&quot;<br />Strip = Cut width × WOF<br />Segs = WOF ÷ Cut<br />Blocks/set = Segs ÷ 2
 </div>
 </div>
