...
<div className={styles.toolHeader}><span className="category-badge"><span>#️⃣</span> Quilt #151</span><h1>Nine-Patch Calculator</h1><p>Strip widths for nine-patch blocks.</p></div>
