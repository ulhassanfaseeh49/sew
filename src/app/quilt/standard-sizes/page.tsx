...
<div className={styles.toolHeader}><span className="category-badge"><BookOpen size={14} strokeWidth={1.5} /> Quilt #133</span><h1>Standard Quilt Sizes</h1><p>Reference for all standard quilt sizes.</p></div>
