            ...
            <div className="calculator-layout">
                <div className="calculator-main">
                    ...
                    <div style={{ display: "flex", gap: 6, marginBottom: 10, flexWrap: "wrap" }}>
                        {([["bed", "🛏️ Bed Quilt"], ["throw", "🛋️ Throw / Lap"], ["baby", "👶 Baby Quilt"], ["wall", "🖼️ Wall Hanging"]] as const).map(([k, label]) => (
                    ...
                    {tab === "baby" && (
                        <div className={`glass-card ${styles.calculatorCard}`}>
                            ...
                            <div style={{ padding: 8, background: "hsl(0,30%,96%)", borderRadius: 6, fontSize: 11, marginBottom: 10, color: "hsl(0,60%,40%)", fontWeight: 600 }}>
                                ⚠️ Safety: Loose quilts in cribs are a SIDS risk for babies under 12 months. Always follow safe sleep guidelines from your pediatrician.
                            </div>
                            <div style={{ overflowX: "auto" }}>
                                <table style={{ fontSize: 12, borderCollapse: "collapse", width: "100%" }}>
                    ...
                    {/* ═══ BATTING REF ═══ */}
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() => setShowBatting(!showBatting)}>
                            🧶 Batting Size Reference
                    ...
                    {/* ═══ DROP & PILLOW GUIDE ═══ */}
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() => setShowDrop(!showDrop)}>
                            📏 Drop Length &amp; Pillow Guide
                ...
                <aside className="calculator-sidebar">
                    ...
                    <div className="glass-card" style={{ padding: "var(--space-5)", marginBottom: "var(--space-4)" }}>
                        ...
                        <div style={{ fontSize: 11, padding: 8, background: "hsl(0,0%,96%)", borderRadius: 6, lineHeight: 2, fontFamily: "monospace" }}>
                            Baby: 36×52<br />Throw: 54×72<br />Twin: 60×80<br />Full: 72×84<br />Queen: 84×92<br />King: 100×108
                        </div>
                    </div>
