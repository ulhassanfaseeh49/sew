...
import { ClipboardCopy, Gem, Printer } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Gem size={14} strokeWidth={1.5} /> Quilt #165</span><h1>Mini Charm Calculator</h1><p>Projects from mini charm packs (2.5 inch squares).</p></div>
