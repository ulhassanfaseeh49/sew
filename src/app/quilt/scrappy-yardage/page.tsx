            ...
            <div className="calculator-layout">
                <div className="calculator-main">
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        ...
                        {valueMode === "color" && (
                            <div style={{ fontSize: 12 }}>
                                ...
                                <div style={{ fontSize: 10, color: colorFams.reduce((s, c) => s + c.pct, 0) === 100 ? "hsl(150,50%,40%)" : "hsl(0,60%,50%)", marginTop: 4 }}>
                                    Total: {colorFams.reduce((s, c) => s + c.pct, 0)}% {colorFams.reduce((s, c) => s + c.pct, 0) === 100 ? "✓" : "— must equal 100%"}
                                </div>
                            </div>
                        )}
                    </div>
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() => setShowReverse(!showReverse)}>
                            🔄 What Can You Make From Your Scraps?
                    ...
                    {(!assess.lOk || !assess.dOk) && (
                        <div className={`glass-card ${styles.calculatorCard}`}>
                            <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() => setShowSupplement(!showSupplement)}>
                            ...
                            {showSupplement && (
                                <div style={{ marginTop: 10, fontSize: 12, lineHeight: 1.9 }}>
                                    ...
                                    <div style={{ fontSize: 11, color: "var(--color-text-tertiary)" }}>
                                        Tip: Buy fat quarter bundles for maximum scrappy variety. A 10-FQ bundle ≈ 2.5 yd of coordinated fabrics.
                                    </div>
                                </div>
                            )}
                        </div>
                    ...
                    {/* ═══ GUILD GROUP ═══ */}
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() => setShowGuild(!showGuild)}>
                            👥 Guild Group Quilt Planner
                ...
                <aside className="calculator-sidebar">
                    ...
                    <div className="glass-card" style={{ padding: "var(--space-5)", marginBottom: "var(--space-4)" }}>
                        ...
                        <div style={{ fontSize: 11, padding: 8, background: "hsl(0,0%,96%)", borderRadius: 6, lineHeight: 2 }}>
                            Baby: ~2 yd<br />
                            Throw: ~4 yd<br />
                            Twin: ~6 yd<br />
                            Queen: ~8.5 yd<br />
