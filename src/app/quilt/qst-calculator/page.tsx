        ...
        <div className="container">
            ...
            <div className="calculator-layout">
                <div className="calculator-main">
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() => setShowConstruction(!showConstruction)}>
                            📋 Two-HST Method (Step-by-Step)
                    ...
                    {/* ═══ FOUR-COLOR ═══ */}
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() => setShowFourColor(!showFourColor)}>
                            🎨 Four-Color QST (Advanced)
                        ...
                        {showFourColor && (
                            <div style={{ marginTop: 10, fontSize: 12, lineHeight: 1.9 }}>
                                <div style={{ padding: 8, background: "hsl(40,20%,96%)", borderRadius: 6, marginBottom: 8 }}>
                                    ⚠️ <strong>Each triangle is a different fabric.</strong> Triangles have bias edges on short legs — handle carefully, use starch.
                                </div>
                        ...
                        {showYardage && (
                            <div style={{ marginTop: 10, fontSize: 12, lineHeight: 1.9 }}>
                                ...
                                <div style={{ fontSize: 11, color: "var(--color-text-tertiary)" }}>
                                    No-waste uses {(((yard.buyPerColor - yard.nwBuy) / yard.buyPerColor) * 100).toFixed(0)}% less fabric but requires trimming each QST to size.
                                </div>
                            </div>
                        )}
                    </div>
                    ...
                    {/* ═══ BLOCK CONTEXT ═══ */}
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() => setShowBlocks(!showBlocks)}>
                            🧩 QSTs in Common Blocks
                        ...
                        {showTrimming && (
                            <div style={{ marginTop: 10, fontSize: 12, lineHeight: 1.9 }}>
                                <div style={{ padding: 8, background: "hsl(40,15%,96%)", borderRadius: 6, marginBottom: 8 }}>
                                    ⚠️ QST trimming is harder than HST — you have <strong>two seams</strong> to align through center.
                                </div>
                                {[
