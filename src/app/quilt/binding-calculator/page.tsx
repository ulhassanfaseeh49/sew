...
<div className={styles.toolHeader}><span className="category-badge"><Ribbon size={14} strokeWidth={1.5} /> Quilt #138</span><h1>Binding Calculator</h1><p>Binding strips and yardage.</p></div>
