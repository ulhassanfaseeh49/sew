                ...
                <div className="calculator-main">
                        ...
                        {mode !== "cutToFin" && (
                            <>
                                <div style={{ fontSize: 12, color: "var(--color-text-tertiary)", marginBottom: 6 }}>
                                    The finished HST is the square measurement AFTER sewing into a block.
                                </div>
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        ...
                        {oversize > 0 && (
                            <div style={{ fontSize: 11, marginTop: 4, color: "var(--color-text-tertiary)" }}>
                                Cut sizes include +{toFrac(oversize)}&quot; oversize. Trim to {toFrac(calc.unfinished)}&quot; unfinished after sewing.
                            </div>
                        )}
                    </div>
                    ...
                    {mode === "fabricYield" && (
                        <div className={`glass-card ${styles.calculatorCard}`} style={{ borderLeft: "4px solid hsl(40,70%,50%)" }}>
                            ...
                            <div style={{ fontSize: 10, marginTop: 4, color: "var(--color-text-tertiary)" }}>
                                Yield from ONE piece of each fabric. You need matching squares from both light and dark.
                            </div>
                        </div>
                    )}
                    ...
                    {mode === "yardage" && (
                        <div className={`glass-card ${styles.calculatorCard}`} style={{ borderLeft: "4px solid hsl(280,50%,55%)" }}>
                            ...
                            <div style={{ marginTop: 6, padding: 8, background: "hsl(45,30%,96%)", borderRadius: 6, fontSize: 12, fontWeight: 600 }}>
                                Total (both fabrics, 2-at-a-time): {toFrac(calc.yd2.buy * 2)} yards
                            </div>
                        </div>
                    )}
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
                            ...
                            ⚖️ Method Efficiency Comparison
                        ...
                        {showCompare && (
                            <div style={{ marginTop: 10, fontSize: 13, lineHeight: 1.8 }}>
                                ...
                                <div style={{ marginTop: 6, fontSize: 11, color: "var(--color-text-tertiary)" }}>
                                    Most fabric efficient: 8-at-a-time. Easiest: 2-at-a-time. Best accuracy: 2-at-a-time with trimming.
                                </div>
                            </div>
                        )}
                    </div>
