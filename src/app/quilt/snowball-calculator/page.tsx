...
export default function Page() {
 ...
 {mode === "ninepatch" && (
 <div style={{ fontSize: 11, marginTop: 4, color: "var(--color-text-secondary)" }}>Alternating: <strong>{calc.totalBlocks} snowball</strong>+ <strong>{calc.npBlocks} nine-patch</strong>= {cols * rows} total
 </div>
 )}
 <div className="input-group" style={{ marginTop: 8 }}>
 ...
 {/* ═══ DEPTH TABLE ═══ */}
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() =>setShowDepthTable(!showDepthTable)}>Corner Size Reference Table
 ...
 {/* ═══ WASTE TRIANGLES ═══ */}
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() =>setShowWaste(!showWaste)}>Waste Triangle Calculator
 ...
 <div style={{ marginTop: 6, fontSize: 11, color: "var(--color-text-tertiary)" }}>Tip: To save HSTs, stitch a second line ¼&quot; from the diagonal BEFORE cutting. Save both layers when trimming corners. Press and trim for bonus HST units.
 </div>
 </div>
 )}
 </div>
 ...
 {/* ═══ EDUCATIONAL ═══ */}
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() =>setShowEdu(!showEdu)}>Understanding Snowball Blocks
 ...
 <div style={{ fontSize: 11, padding: 8, background: "hsl(0,0%,96%)", borderRadius: 6, fontFamily: "monospace", lineHeight: 2 }}>Corner cut = leg + ½&quot;<br />
 ⅓ depth: block ÷ 3 + ½&quot;<br />
 ½ depth: block ÷ 2 + ½&quot;<br />Stitch ON the line!
 </div>
 </div>
