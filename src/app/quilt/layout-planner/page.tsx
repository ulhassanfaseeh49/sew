...
export default function Page() {
 ...
 onClick={() =>setShowTemplates(!showTemplates)}>Template Library
 ...
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }}
 onClick={() =>setShowComparison(!showComparison)}>Side-by-Side Comparison
 ...
 onClick={() =>setShowEdu(!showEdu)}>Design Tips & How To Use
