...
<div className={styles.toolHeader}><span className="category-badge"><span></span> Quilt #131</span><h1>Quilt Layout Planner</h1><p>Visual grid planner for block arrangement.</p></div>
