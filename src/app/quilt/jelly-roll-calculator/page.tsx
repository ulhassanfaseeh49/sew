...
export default function Page() {
 ...
 <div style={{ marginTop: 6, fontSize: 11, color: "var(--color-text-tertiary)" }}>Result varies slightly based on technique. Most sources report ~50&quot;×65&quot; from 40 strips.
 </div>
 </div>
 </div>
 )}
 ...
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }}
 onClick={() =>setShowJRRef(!showJRRef)}>Jelly Rolls Needed for Standard Sizes
 ...
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }}
 onClick={() =>setShowEdu(!showEdu)}>What Is a Jelly Roll &amp; Tips
