...
export default function Page() {
 ...
 <div style={{ fontSize: 13, lineHeight: 1.8, color: "var(--color-text-secondary)" }}>When people say &quot;a 1-inch hexagon&quot; they mean the <strong>SIDE LENGTH = 1 inch</strong>. The side determines everything:
 <div style={{ fontFamily: "monospace", margin: "6px 0", padding: 8, background: "hsl(200,15%,97%)", borderRadius: 6 }}>Width (point to point) = side × 2<br />Height (flat to flat) = side × √3 ≈ side × 1.732
 </div>
 </div>
 </div>
 ...
 onClick={() =>setShowFlower(!showFlower)}>Grandmother&apos;s Flower Garden Planner
 ...
 <div style={{ fontSize: 11, marginTop: 4, color: "var(--color-text-tertiary)" }}>Paper templates needed: {calc.totalHexes} papers
 </div>
 </div>
 </div>
 )}
 ...
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
 onClick={() =>setShowYardage(!showYardage)}>Yardage Estimate
 ...
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
 onClick={() =>setShowRef(!showRef)}>Hexagon Size Reference Table
 ...
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
 onClick={() =>setShowQuiltRef(!showQuiltRef)}>Hexagon Count by Quilt Size
 ...
 <div style={{ fontSize: 9, marginTop: 4, color: "var(--color-text-tertiary)" }}>Based on 1&quot; side hexagons in solid grid layout. GFG layouts may differ.
 </div>
 </div>
 )}
 </div>
 ...
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
 onClick={() =>setShowBasting(!showBasting)}>Flower Ring Count Reference
 ...
 <div style={{ fontSize: 10, marginTop: 4, color: "var(--color-text-tertiary)" }}>Formula: hexagons in ring N = 6N. Total through ring N = 3N² + 3N + 1. Traditional GFG = 2 rings (19 hex).
 </div>
 </div>
 )}
 </div>
 ...
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
 onClick={() =>setShowCompat(!showCompat)}>Compatible EPP Shapes
 ...
 <div style={{ fontSize: 11, marginTop: 4, color: "var(--color-text-tertiary)" }}>All compatible shapes use the same side length ({toFrac(side)}&quot;) for seamless EPP assembly.
 </div>
 </div>
 )}
 </div>
 ...
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
 onClick={() =>setShowMath(!showMath)}>Hexagon Math Explained
