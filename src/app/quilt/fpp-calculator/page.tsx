        ...
        <div className="container">
            ...
            <div className="calculator-layout">
                <div className="calculator-main">
                    ...
                    {mode === "B" && (
                        <>
                            ...
                            <div className={`glass-card ${styles.calculatorCard}`} style={{ borderLeft: "4px solid hsl(150,60%,40%)" }}>
                                ...
                                <div style={{ marginTop: 8, padding: 8, background: "hsl(45,30%,96%)", borderRadius: 6, fontSize: 12, color: "var(--color-text-secondary)" }}>
                                    💡 The {toFrac(sa)}&quot; on each side ensures fabric fully covers the section after sewing and flipping. Excess is trimmed away after stitching — this waste is the price of precision!
                                </div>
                            </div>
                        </>
                    )}
                        ...
                        <>
                            <div className={`glass-card ${styles.calculatorCard}`}>
                                ...
                                <div style={{ fontSize: 12, marginTop: 6, color: "var(--color-text-tertiary)" }}>
                                    Measure the block outline on your printed template, or a 1&quot; reference line if included.
                                </div>
                            </div>
                        ...
                        <>
                            ...
                            <div className={`glass-card ${styles.calculatorCard}`}>
                                ...
                                <div style={{ fontSize: 12, marginBottom: 6, color: "var(--color-text-secondary)" }}>
                                    How many sections use each fabric color?
                            ...
                            <div className={`glass-card ${styles.calculatorCard}`} style={{ borderLeft: "4px solid hsl(150,60%,40%)" }}>
                                ...
                                {yardageCalc.map((c, i) => (
                                    <div key={i} style={{ padding: 10, background: i % 2 === 0 ? "hsl(200,15%,97%)" : "hsl(150,15%,97%)", borderRadius: 6, marginBottom: 6, fontSize: 12, lineHeight: 1.8 }}>
                                        <div style={{ fontWeight: 700, color: i % 2 === 0 ? "hsl(200,60%,35%)" : "hsl(150,60%,35%)" }}>
                                            Color {c.color} — {c.pieces} sections/block × {numBlocks} = {c.total} pieces
                                        </div>
                        ...
                        {showRef && (
                            <div style={{ marginTop: 10, overflowX: "auto" }}>
                                ...
                                <div style={{ fontSize: 10, marginTop: 4, color: "var(--color-text-tertiary)" }}>
                                    SA added to EACH edge (×2 per dimension). Round up to nearest useful measure.
                                </div>
                            </div>
                        )}
                    </div>
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
                            onClick={() => setShowResizeRef(!showResizeRef)}>
                            🔄 Print Percentage Reference
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
                            ...
                            📦 Common FPP Block Fabric Estimates
                        ...
                        {showEstimates && (
                            <div style={{ marginTop: 10, overflowX: "auto" }}>
                                ...
                                <div style={{ fontSize: 10, marginTop: 4, color: "var(--color-text-tertiary)" }}>
                                    Estimates for 12&quot; finished blocks. Use the calculator above for precise yardage.
                                </div>
                            </div>
                        )}
                    </div>
