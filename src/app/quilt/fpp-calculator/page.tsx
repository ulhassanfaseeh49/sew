...
<div className={styles.toolHeader}><span className="category-badge"><FileText size={14} strokeWidth={1.5} /> Quilt #158</span><h1>FPP Size Calculator</h1><p>Template and fabric sizes for foundation paper piecing.</p></div>
