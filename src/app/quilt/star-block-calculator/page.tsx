...
<div className={styles.toolHeader}><span className="category-badge"><span>⭐</span> Quilt #155</span><h1>Star Block Calculator</h1><p>Cutting dimensions for star blocks.</p></div>
