...
<div className={styles.toolHeader}><span className="category-badge"><span>📊</span> Quilt #147</span><h1>HST Yield Calculator</h1><p>How many HSTs from a given square.</p></div>
