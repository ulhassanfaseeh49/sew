...
import { ClipboardCopy, Palette, Printer } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Palette size={14} strokeWidth={1.5} /> Quilt #134</span><h1>Virtual Design Wall</h1><p>Visual design wall for block arrangement.</p></div>
