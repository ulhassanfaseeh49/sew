            ...
            <div className="calculator-layout">
                <div className="calculator-main">
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        ...
                        {placingDefId && (
                            <div style={{ marginTop: 8, padding: 8, background: "hsl(150,40%,95%)", borderRadius: 6, fontSize: 12, color: "hsl(150,60%,30%)", fontWeight: 600 }}>
                                ✋ Click on the canvas below to place: {blockDefs.find(d => d.id === placingDefId)?.name}
                            </div>
                        )}
                    </div>
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
                            ...
                            📚 Tips for Good Quilt Composition
