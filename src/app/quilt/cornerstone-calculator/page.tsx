...
export default function Page() {
 ...
 <div style={{ fontSize: 12, color: "var(--color-text-tertiary)", marginTop: 4 }}>Total blocks: {cols} × {rows} = {cols * rows}
 </div>
 </div>
 ...
 onClick={() =>setShowRef(!showRef)}>Cornerstone Count Reference Table
 ...
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
 onClick={() =>setShowEdu(!showEdu)}>Why the Cornerstone Count Confuses Most Quilters
