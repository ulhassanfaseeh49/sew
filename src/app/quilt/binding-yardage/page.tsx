                ...
                <div className="calculator-main">
                            ...
                            {modeAResult.isLof && (
                                <div style={{ background: "hsl(35,90%,95%)", borderRadius: "var(--radius-md)", padding: 14, marginTop: 10, fontSize: 13 }}>
                                    ...
                                    <div style={{ marginTop: 6, lineHeight: 1.8 }}>
                                        LOF strips run the full length of the fabric. For {Math.round(modeAResult.totalLen)}&quot; of binding, you need a single piece {Math.round(modeAResult.totalLen)}&quot; long.
                    ...
                    {mode === "A" && (
                        <div className={`glass-card ${styles.calculatorCard}`}>
                            <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
                                onClick={() => setShowWidthComp(!showWidthComp)}>
                                📊 How Fabric Width Affects Your Purchase <ChevronDown size={14} style={{ transform: showWidthComp ? "rotate(180deg)" : "none", transition: "0.2s" }} />
                            </button>
                            {showWidthComp && (
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
                            ...
                            📚 Understanding Strip-to-Yardage Conversion <ChevronDown size={14} style={{ transform: showEdu ? "rotate(180deg)" : "none", transition: "0.2s" }} />
                        </button>
                        {showEdu && (
