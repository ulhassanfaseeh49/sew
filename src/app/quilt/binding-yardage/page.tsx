...
<div className={styles.toolHeader}><span className="category-badge"><Scissors size={14} strokeWidth={1.5} /> Quilt #141</span><h1>Binding Yardage</h1><p>Yardage from strip count.</p></div>
