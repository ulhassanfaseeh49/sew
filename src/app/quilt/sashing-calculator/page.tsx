...
<div className={styles.toolHeader}><span className="category-badge"><Plus size={14} strokeWidth={1.5} /> Quilt #142</span><h1>Sashing Calculator</h1><p>Sashing dimensions and yardage.</p></div>
