...
import { ClipboardCopy, Cloud, Printer } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Cloud size={14} strokeWidth={1.5} /> Quilt #137</span><h1>Batting Size</h1><p>Determine batting size needed.</p></div>
