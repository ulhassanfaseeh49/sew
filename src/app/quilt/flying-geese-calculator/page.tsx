...
export default function Page() {
 ...
 <div style={{ fontSize: 12, marginTop: 6, color: "var(--color-text-tertiary)" }}>Ratio: <strong>{calc.ratio}:1</strong>{Math.abs(calc.ratio - 2) < 0.01 ? "(standard)" : calc.ratio >2 ? "(wide)" : "(tall)"}
 ...
 <div style={{ fontSize: 12, fontWeight: 600, marginBottom: 6, color: "var(--color-text-secondary)" }}>Geese sizes that fit {borderEdge}&quot; perfectly (2:1 ratio)
 </div>
 ...
 <div style={{ fontSize: 11, marginTop: 6, color: "var(--color-text-tertiary)" }}>Click a row to select that size. Corner squares: {toFrac(finW)}&quot; × {toFrac(finW)}&quot;
 </div>
 </div>
 )}
 ...
 {geeseSvg}
 <div style={{ fontSize: 11, color: "var(--color-text-tertiary)" }}>Unfinished: {toFrac(calc.unfinW)}&quot; × {toFrac(calc.unfinH)}&quot; • Ratio: {calc.ratio}:1
 </div>
 </div>
 ...
 {/* Formulas */}
 <div style={{ marginTop: 8, fontSize: 11, color: "var(--color-text-tertiary)", lineHeight: 1.8, fontFamily: "monospace" }}>Traditional: Rect = (W+½&quot;) × (H+½&quot;), Sq = (H+½&quot;)² &nbsp;|&nbsp; No-waste: Lg = W+1¼&quot;, Sm = H+⅞&quot;
 </div>
 </div>
 ...
 onClick={() =>setShowRef(!showRef)}>Flying Geese Size Reference
 ...
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
 onClick={() =>setShowInstructions(!showInstructions)}>Construction Instructions
 ...
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", textAlign: "left", justifyContent: "space-between" }}
 onClick={() =>setShowTrouble(!showTrouble)}>Troubleshooting Flying Geese
