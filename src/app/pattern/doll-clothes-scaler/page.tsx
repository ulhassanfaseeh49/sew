  ...
  return (
    <div className="container">
      ...
      <div className="calculator-layout">
        ...
        <aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/pattern/percentage-scaler" className="related-tool-link"><Ruler size={13} /> % Scaler</a><a href="/pattern/reduction-calculator" className="related-tool-link"> Reduction</a></div></aside>
      </div>
    </div>
  );
}