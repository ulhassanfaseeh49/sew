      ...
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><span>📐</span> Pattern Tool #98</span>
        ...
        <aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/pattern/enlargement-calculator" className="related-tool-link">🔍 Enlargement</a><a href="/pattern/copy-shop-guide" className="related-tool-link">🖨️ Copy Shop</a></div></aside>
      </div>
    </div>
  );
}