  ...
  return (
    <div className="container">
      ...
      <div className="calculator-layout">
        ...
        <aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/pattern/full-bust-adjustment" className="related-tool-link"><Shirt size={13} /> FBA</a><a href="/pattern/ease-calculator" className="related-tool-link"><Ruler size={13} /> Ease</a></div></aside>
      </div>
    </div>
  );
}