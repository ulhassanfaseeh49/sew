  ...
  return (
    <div className="container">
      ...
      <div className="calculator-layout">
        ...
        <aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/pattern/size-grader" className="related-tool-link"><BarChart3 size={13} /> Size Grader</a><a href="/pattern/between-sizes-grader" className="related-tool-link"> Between Sizes</a></div></aside>
      </div>
    </div>
  );
}