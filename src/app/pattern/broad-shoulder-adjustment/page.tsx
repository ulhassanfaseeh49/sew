      ...
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><span>💪</span> Pattern Tool #107</span>
        ...
        <aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/pattern/full-bust-adjustment" className="related-tool-link">👗 FBA</a><a href="/pattern/size-grader" className="related-tool-link">📊 Size Grader</a></div></aside>
      </div>
    </div>
  );
}