...
import { ArrowLeftRight, ClipboardCopy, Plus, Printer, Scissors } from "lucide-react";
      ...
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><Scissors size={14} strokeWidth={1.5} /> Pattern Tool</span>
        ...
        <aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/seam-allowance/adder" className="related-tool-link"><Plus size={13} /> SA Adder</a><a href="/seam-allowance/converter" className="related-tool-link"><ArrowLeftRight size={13} /> SA Converter</a></div></aside>
      </div>
    </div>
  );
}