...
import { ClipboardCopy, Printer, Repeat, Ruler } from "lucide-react";
      ...
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><Repeat size={14} strokeWidth={1.5} /> Pattern Tool</span>
        ...
        <aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/yardage/pattern-repeat-calculator" className="related-tool-link"><Repeat size={13} /> Repeat Yardage</a><a href="/pattern/percentage-scaler" className="related-tool-link"><Ruler size={13} /> % Scaler</a></div></aside>
      </div>
    </div>
  );
}