      ...
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><Search size={14} strokeWidth={1.5} /> Pattern Tool</span>
        ...
        <aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/pattern/reduction-calculator" className="related-tool-link"> Reduction</a><a href="/pattern/copy-shop-guide" className="related-tool-link"><Printer size={13} /> Copy Shop</a></div></aside>
      </div>
    </div>
  );
}