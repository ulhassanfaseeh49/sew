      ...
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><span>🔎</span> Pattern Tool #97</span>
        ...
        <aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/pattern/enlargement-calculator" className="related-tool-link">🔍 Enlargement</a><a href="/pattern/doll-clothes-scaler" className="related-tool-link">🪆 Doll Clothes</a></div></aside>
      </div>
    </div>
  );
}