...
import { ClipboardCopy, Printer, Ruler, Shirt, Wrench } from "lucide-react";
  ...
  return (
    <div className="container">
      ...
      <div className="calculator-layout">
        ...
        <aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/pattern/ease-adjuster" className="related-tool-link"><Wrench size={13} /> Ease Adjuster</a><a href="/pattern/full-bust-adjustment" className="related-tool-link"><Shirt size={13} /> FBA</a></div></aside>
      </div>
    </div>
  );
}