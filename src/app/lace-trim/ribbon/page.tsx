...
<div className={styles.toolHeader}><span className="category-badge"><Ribbon size={14} strokeWidth={1.5} /> Trim #326</span><h1>Ribbon Calculator</h1><p>Ribbon for bows, sashes, edges.</p></div>
