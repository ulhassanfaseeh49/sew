...
<div className={styles.toolHeader}><span className="category-badge"><span>📖</span> Trim #330</span><h1>Trim Placement Guide</h1><p>Visual guide for trim placement.</p></div>
