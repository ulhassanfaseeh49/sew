...
import { ClipboardCopy, Printer, Zap } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Zap size={14} strokeWidth={1.5} /> Trim #325</span><h1>Rickrack Yardage Calculator</h1><p>Rickrack/zigzag trim yardage.</p></div>
