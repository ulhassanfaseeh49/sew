...
<div className={styles.toolHeader}><span className="category-badge"><Scissors size={14} strokeWidth={1.5} /> Trim #332</span><h1>Cording and Soutache</h1><p>Decorative cording yardage.</p></div>
