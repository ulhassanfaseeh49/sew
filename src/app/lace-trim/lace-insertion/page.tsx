...
<div className={styles.toolHeader}><span className="category-badge"><span>📏</span> Trim #324</span><h1>Lace Insertion Calculator</h1><p>Yardage for lace insertion.</p></div>
