...
<div className={styles.toolHeader}><span className="category-badge"><span>〰️</span> Trim #323</span><h1>Gathered Lace Calculator</h1><p>Lace for gathered/ruffled application.</p></div>
