...
<div className={styles.toolHeader}><span className="category-badge"><Link size={14} strokeWidth={1.5} /> Trim #328</span><h1>Tassel Maker Calculator</h1><p>Thread for making tassels.</p></div>
