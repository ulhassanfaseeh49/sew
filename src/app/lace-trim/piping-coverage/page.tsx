...
<div className={styles.toolHeader}><span className="category-badge"><span>〰️</span> Trim #329</span><h1>Piping Coverage Calculator</h1><p>Piping yardage for edges.</p></div>
