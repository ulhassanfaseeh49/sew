...
export default function Page() {
    const guides = [
        ...
        { title: "Understanding Fabric Weight (GSM)", href: "/fabric-type/gsm-to-oz", icon: "⚖️", desc: "What GSM means and how to convert units" },
        { title: "Pressing vs Ironing — What's the Difference?", href: "/reference/pressing-guide", icon: "♨️", desc: "Why pressing matters and how to do it right" },
        ...
        { title: "Sustainable Sewing Guide", href: "/sustainable", icon: "♻️", desc: "Reduce waste and sew eco-friendly" },
