...
<div className={styles.toolHeader}><span className="category-badge"><Scissors size={14} strokeWidth={1.5} /> Embroidery #315</span><h1>Cross-Stitch Thread Usage</h1><p>Skeins needed per color.</p></div>
