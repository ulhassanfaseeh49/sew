...
<div className={styles.toolHeader}><span className="category-badge"><Flame size={14} strokeWidth={1.5} /> Embroidery #319</span><h1>Fusible Applique Calculator</h1><p>Fusible web for applique projects.</p></div>
