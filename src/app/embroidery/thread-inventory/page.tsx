...
import { ClipboardCopy, Package, Printer, Scissors } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Package size={14} strokeWidth={1.5} /> Embroidery #320</span><h1>Thread Inventory Tracker</h1><p>Track your thread collection.</p></div>
