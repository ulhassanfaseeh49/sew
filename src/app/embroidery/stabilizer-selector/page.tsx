...
<div className={styles.toolHeader}><span className="category-badge"><span>📋</span> Embroidery #311</span><h1>Stabilizer Type Selector</h1><p>Pick the right stabilizer.</p></div>
