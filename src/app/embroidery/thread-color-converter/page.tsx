...
<div className={styles.toolHeader}><span className="category-badge"><span>🎨</span> Embroidery #313</span><h1>Thread Color Converter</h1><p>DMC/Anchor/Sulky conversion.</p></div>
