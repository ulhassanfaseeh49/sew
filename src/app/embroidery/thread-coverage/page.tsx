...
<div className={styles.toolHeader}><span className="category-badge"><span>🧵</span> Embroidery #309</span><h1>Thread Coverage Calculator</h1><p>Estimate thread for embroidery designs.</p></div>
