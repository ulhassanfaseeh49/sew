...
<div className={styles.toolHeader}><span className="category-badge"><Hash size={14} strokeWidth={1.5} /> Embroidery #314</span><h1>Cross-Stitch Fabric Count</h1><p>Finished size by fabric count.</p></div>
