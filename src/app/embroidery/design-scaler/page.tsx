...
import { ClipboardCopy, Printer, Scissors, Search } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Search size={14} strokeWidth={1.5} /> Embroidery #312</span><h1>Design Size Scaler</h1><p>Resize embroidery designs.</p></div>
