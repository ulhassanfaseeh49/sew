...
<div className={styles.toolHeader}><span className="category-badge"><span>📐</span> Embroidery #316</span><h1>Cross-Stitch Fabric Size</h1><p>Fabric piece size needed.</p></div>
