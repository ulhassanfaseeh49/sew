...
<div className={styles.toolHeader}><span className="category-badge"><span>✂️</span> Embroidery #318</span><h1>Applique Fabric Yardage</h1><p>Fabric for applique pieces.</p></div>
