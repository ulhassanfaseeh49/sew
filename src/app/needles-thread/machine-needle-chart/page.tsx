...
<div className={styles.toolHeader}><span className="category-badge"><ClipboardCopy size={14} strokeWidth={1.5} /> Needle #433</span><h1>Machine Needle Chart</h1><p>Complete needle reference chart.</p></div>
