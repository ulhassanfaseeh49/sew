...
<div className={styles.toolHeader}><span className="category-badge"><RefreshCw size={14} strokeWidth={1.5} /> Needle #429</span><h1>Needle Size Converter</h1><p>EU vs US needle sizes.</p></div>
