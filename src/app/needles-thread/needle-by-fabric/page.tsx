...
<div className={styles.toolHeader}><span className="category-badge"><Scissors size={14} strokeWidth={1.5} /> Needle #428</span><h1>Needle by Fabric Guide</h1><p>Match needle size to fabric type.</p></div>
