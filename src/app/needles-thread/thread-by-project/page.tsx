...
<div className={styles.toolHeader}><span className="category-badge"><Scissors size={14} strokeWidth={1.5} /> Needle #430</span><h1>Thread Weight Guide</h1><p>Thread weight by project type.</p></div>
