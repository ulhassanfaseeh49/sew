...
<div className={styles.toolHeader}><span className="category-badge"><span>📊</span> Needle #432</span><h1>Needle Type Comparator</h1><p>Compare needle types and uses.</p></div>
