...
export default function Page() {
 ...
 {/* ═══ BREAKDOWN ═══ */}
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() =>setShowBreakdown(!showBreakdown)}>Calculation Breakdown
 ...
 <strong>Width Math:</strong><br />Window: {winW}&quot; + extensions: {rodExt * 2}&quot; = rod: {calc.rodW}&quot;<br />
 ...
 <strong>Length Math:</strong><br />Finished length: {calc.finLen}&quot;<br />
 ...
 {lined && (
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() =>setShowLining(!showLining)}>Lining Details
 ...
 {/* ═══ REFERENCE TABLE ═══ */}
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() =>setShowRef(!showRef)}>Fullness Reference Table
 ...
 {/* ═══ EDUCATIONAL ═══ */}
 <div className={`glass-card ${styles.calculatorCard}`}>
 <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }} onClick={() =>setShowEdu(!showEdu)}>Understanding Curtain Yardage
 ...
 <div style={{ fontSize: 11, padding: 8, background: "hsl(0,0%,96%)", borderRadius: 6, fontFamily: "monospace", lineHeight: 2 }}>Cut length: {calc.cutLen}&quot;<br />Fab widths: {calc.totalWidths}<br />Rod width: {calc.rodW}&quot;
 </div>
 </div>
