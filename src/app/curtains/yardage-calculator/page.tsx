...
<div className={styles.toolHeader}><span className="category-badge"><Frame size={14} strokeWidth={1.5} /> Curtain #238</span><h1>Curtain Yardage Calculator</h1><p>Complete curtain fabric calculator.</p></div>
