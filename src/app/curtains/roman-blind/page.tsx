...
const w=parseFloat(winW)||0;const h=parseFloat(winH)||0;const cutW=w+4;const cutH=h+12;const yd=Math.ceil(cutW*cutH/(54*36)*4)/4;const hasResult=w>0&&h>0;const resultValue=yd+" yards face fabric";const resultLabel="cut "+cutW+"\" × "+cutH+"\" (same for lining)";
const faqItems=[{q:"How many folds in a Roman blind?",a:"Typically 5-8 folds, spaced 6-8 inches apart. Odd numbers look best."}];
return(<div className="container"><Breadcrumb items={[{label:"Curtains",href:"/curtains"},{label:"Roman Blind Calculator"}]}/>
<div className="calculator-layout"><div className="calculator-main">
<div className={styles.toolHeader}><span className="category-badge"><ClipboardCopy size={14} strokeWidth={1.5} /> Curtain #248</span><h1>Roman Blind Calculator</h1><p>Fabric for Roman shades.</p></div>
