...
<div className={styles.toolHeader}><span className="category-badge"><span>📖</span> Curtain #254</span><h1>Window Measurement Guide</h1><p>How to measure windows for treatments.</p></div>
