...
<div className={styles.toolHeader}><span className="category-badge"><span></span> Curtain #247</span><h1>Pelmet/Cornice Calculator</h1><p>Fabric and board for pelmets.</p></div>
