...
import { ClipboardCopy, Frame, Printer, Ribbon } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Ribbon size={14} strokeWidth={1.5} /> Curtain #252</span><h1>Swag and Tail Calculator</h1><p>Fabric for swag and tail treatments.</p></div>
