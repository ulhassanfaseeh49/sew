...
import { ClipboardCopy, Cloud, Frame, Printer } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Cloud size={14} strokeWidth={1.5} /> Curtain #245</span><h1>Interlining Calculator</h1><p>Interlining for professional curtains.</p></div>
