...
<div className={styles.toolHeader}><span className="category-badge"><span></span> Curtain #239</span><h1>Curtain Fullness Ratio</h1><p>Fabric width for different fullness levels.</p></div>
