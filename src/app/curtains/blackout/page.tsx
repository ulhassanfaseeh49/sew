...
<div className={styles.toolHeader}><span className="category-badge"><span>🌙</span> Curtain #253</span><h1>Blackout Curtain Calculator</h1><p>Yardage for blackout curtains with overlap.</p></div>
