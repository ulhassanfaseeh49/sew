...
<div className={styles.toolHeader}><span className="category-badge"><span>📏</span> Curtain #240</span><h1>Panel Width Calculator</h1><p>Individual panel width from total width.</p></div>
