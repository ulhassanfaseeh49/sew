...
<div className={styles.toolHeader}><span className="category-badge"><Ruler size={14} strokeWidth={1.5} /> Curtain #241</span><h1>Curtain Length Calculator</h1><p>Calculate length for sill, floor, and puddle.</p></div>
