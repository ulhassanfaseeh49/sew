...
import { BarChart3, BookOpen, ClipboardCopy, Printer, Ruler } from "lucide-react";
export default function Page(){
  ...
  return(<div className="container"><Breadcrumb items={[{label:"Body Tools",href:"/body"},{label:"Bra Size Calculator"}]}/>
    <div className="calculator-layout"><div className="calculator-main">
      <div className={styles.toolHeader}><span className="category-badge"><Ruler size={14} strokeWidth={1.5} /> Body Tool</span><h1>Bra Size Calculator</h1><p>Calculate bra size from band and bust measurements.</p></div>
    ...
    </div><aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/body/measurement-guide" className="related-tool-link"><BookOpen size={13} /> Guide</a><a href="/body/standard-measurements" className="related-tool-link"><BarChart3 size={13} /> Standards</a></div></aside></div></div>);
}