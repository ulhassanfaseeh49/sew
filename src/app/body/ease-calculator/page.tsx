...
export default function Page(){
  ...
  return(<div className="container"><Breadcrumb items={[{label:"Body Tools",href:"/body"},{label:"Ease Calculation Tool"}]}/>
    ...
    </div><aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/pattern/ease-adjuster" className="related-tool-link"><Ruler size={13} /> Pattern Ease</a><a href="/body/measurement-guide" className="related-tool-link"><BookOpen size={13} /> Guide</a></div></aside></div></div>);
}