...
export default function Page(){
  ...
  return(<div className="container"><Breadcrumb items={[{label:"Body Tools",href:"/body"},{label:"How to Measure Yourself"}]}/>
    <div className="calculator-layout"><div className="calculator-main">
      <div className={styles.toolHeader}><span className="category-badge"><span>📖</span> Body Tool #113</span><h1>How to Measure Yourself</h1><p>Step-by-step guide for taking all body measurements accurately.</p></div>
    ...
    </div><aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/body/measurement-tracker" className="related-tool-link">📋 Tracker</a><a href="/body/ease-calculator" className="related-tool-link">📏 Ease</a></div></aside></div></div>);
}