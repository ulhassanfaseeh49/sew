...
export default function Page(){
  ...
  return(<div className="container"><Breadcrumb items={[{label:"Body Tools",href:"/body"},{label:"Pattern Size Selector"}]}/>
    <div className="calculator-layout"><div className="calculator-main">
      <div className={styles.toolHeader}><span className="category-badge"><span>🎯</span> Body Tool #121</span><h1>Pattern Size Selector</h1><p>Input measurements to get recommended pattern size.</p></div>
    ...
    </div><aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/body/standard-measurements" className="related-tool-link">📊 Standards</a><a href="/body/brand-size-comparator" className="related-tool-link">⚖️ Compare</a></div></aside></div></div>);
}