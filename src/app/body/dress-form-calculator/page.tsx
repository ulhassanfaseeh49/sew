...
export default function Page(){
  ...
  return(<div className="container"><Breadcrumb items={[{label:"Body Tools",href:"/body"},{label:"Dress Form Size Calculator"}]}/>
    <div className="calculator-layout"><div className="calculator-main">
      <div className={styles.toolHeader}><span className="category-badge"><Shirt size={14} strokeWidth={1.5} /> Body Tool</span><h1>Dress Form Size Calculator</h1><p>Determine what size dress form to buy.</p></div>
    ...
    </div><aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/body/dress-form-padding" className="related-tool-link"><Scissors size={13} /> Padding</a><a href="/body/measurement-tracker" className="related-tool-link"><ClipboardCopy size={13} /> Tracker</a></div></aside></div></div>);
}