...
export default function Page(){
  ...
  return(<div className="container"><Breadcrumb items={[{label:"Body Tools",href:"/body"},{label:"Brand Size Comparator"}]}/>
    <div className="calculator-layout"><div className="calculator-main">
      <div className={styles.toolHeader}><span className="category-badge"><span>⚖️</span> Body Tool #122</span><h1>Brand Size Comparator</h1><p>Compare sizing between pattern brands.</p></div>
    ...
    </div><aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/body/standard-measurements" className="related-tool-link">📊 Standards</a><a href="/body/pattern-size-selector" className="related-tool-link">🎯 Size Selector</a></div></aside></div></div>);
}