...
export default function Page(){
  ...
  return(<div className="container"><Breadcrumb items={[{label:"Body Tools",href:"/body"},{label:"Body Measurement Tracker"}]}/>
    <div className="calculator-layout"><div className="calculator-main">
      <div className={styles.toolHeader}><span className="category-badge"><span>📋</span> Body Tool #114</span><h1>Body Measurement Tracker</h1><p>Record and track your body measurements.</p></div>
    ...
    </div><aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/body/measurement-guide" className="related-tool-link">📖 Guide</a><a href="/body/pattern-size-selector" className="related-tool-link">🎯 Size Selector</a></div></aside></div></div>);
}