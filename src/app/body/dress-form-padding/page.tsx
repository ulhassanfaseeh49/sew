...
import { ClipboardCopy, Printer, Scissors, Shirt } from "lucide-react";
export default function Page(){
  ...
  return(<div className="container"><Breadcrumb items={[{label:"Body Tools",href:"/body"},{label:"Dress Form Padding Calculator"}]}/>
    <div className="calculator-layout"><div className="calculator-main">
      <div className={styles.toolHeader}><span className="category-badge"><Scissors size={14} strokeWidth={1.5} /> Body Tool</span><h1>Dress Form Padding Calculator</h1><p>Calculate padding needed to match your measurements.</p></div>
    ...
    </div><aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/body/dress-form-calculator" className="related-tool-link"><Shirt size={13} /> Form Size</a><a href="/body/measurement-tracker" className="related-tool-link"><ClipboardCopy size={13} /> Tracker</a></div></aside></div></div>);
}