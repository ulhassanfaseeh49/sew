    ...
    return (
        <div className="container" style={{ paddingBottom: "5rem" }}>
            ...
            <div style={{ textAlign: "center", marginBottom: "3rem" }}>
                <span className="category-badge" style={{ marginBottom: "1rem", display: "inline-flex" }}><Ruler size={14} strokeWidth={1.5} /> Category 6</span>
                ...
                <div style={{ display: "flex", gap: "2rem", justifyContent: "center", marginTop: "1.5rem", flexWrap: "wrap" }}>
                    <div className="stat-badge"><Ruler size={13} /> 16 Tools</div>
