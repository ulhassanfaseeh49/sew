...
export default function Page(){
  ...
  return(<div className="container"><Breadcrumb items={[{label:"Body Tools",href:"/body"},{label:"Multi-Person Measurement Manager"}]}/>
    <div className="calculator-layout"><div className="calculator-main">
      <div className={styles.toolHeader}><span className="category-badge"><span>👥</span> Body Tool #126</span><h1>Multi-Person Measurement Manager</h1><p>Store measurements for multiple people.</p></div>
    ...
    </div><aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/body/measurement-tracker" className="related-tool-link">📋 Tracker</a><a href="/body/measurement-guide" className="related-tool-link">📖 Guide</a></div></aside></div></div>);
}