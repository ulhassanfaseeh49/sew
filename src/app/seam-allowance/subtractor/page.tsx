      ...
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><span>➖</span> Seam Tool #85</span>
        ...
        <aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/seam-allowance/adder" className="related-tool-link">➕ Adder</a><a href="/seam-allowance/converter" className="related-tool-link">↔️ Converter</a></div></aside>
      </div>
    </div>
  );
}