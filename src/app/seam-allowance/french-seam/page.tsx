      ...
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><span>🇫🇷</span> Seam Tool #89</span>
        ...
        <aside className="calculator-sidebar"><div className="glass-card related-tools"><h4>Related Tools</h4><a href="/seam-allowance/flat-felled" className="related-tool-link">👖 Flat-Felled</a><a href="/seam-allowance/hong-kong" className="related-tool-link">🎀 Hong Kong</a></div></aside>
      </div>
    </div>
  );
}