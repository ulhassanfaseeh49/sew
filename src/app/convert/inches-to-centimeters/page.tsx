                ...
                <div className="calculator-main">
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        ...
                        {parsed === null && raw.length > 0 && (
                            <div style={{ marginTop: 10, padding: 8, background: "hsl(0,30%,97%)", borderRadius: 6, fontSize: 12, color: "hsl(0,60%,45%)" }}>
                                Please enter a valid measurement. Examples: 5/8, 1/4, 2.5, 36, or 1-3/4
                            </div>
                        )}
                    </div>
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }}
                            onClick={() => setShowSeamSec(!showSeamSec)}>
                            📐 Seam Allowance Conversions Guide
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }}
                            onClick={() => setShowBodySec(!showBodySec)}>
                        ...
                        {showBodySec && (
                            <div style={{ marginTop: 10, overflowX: "auto" }}>
                                ...
                                <div style={{ marginTop: 6, fontSize: 11, color: "var(--color-text-tertiary)" }}>
                                    Precision matters for body measurements — round to the nearest 0.5 cm. Even 0.5 cm can affect garment fit.
                                </div>
                            </div>
                        )}
                    </div>
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }}
                            onClick={() => setShowFabricSec(!showFabricSec)}>
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }}
                            ...
                            🔢 The Formula &amp; Mental Math Tricks
                        ...
                        {showFormula && (
                            <div style={{ marginTop: 10, fontSize: 12.5, lineHeight: 1.9, color: "var(--color-text-secondary)" }}>
                                <div style={{ padding: 10, background: "hsl(150,15%,97%)", borderRadius: 6, fontFamily: "monospace", fontSize: 16, fontWeight: 700, textAlign: "center", marginBottom: 8 }}>
                    ...
                    <div className={`glass-card ${styles.calculatorCard}`}>
                        <button className="btn btn-sm btn-secondary" style={{ width: "100%", justifyContent: "space-between" }}
                            onClick={() => setShowRoundGuide(!showRoundGuide)}>
                            🎯 Practical Rounding Guide for Sewists
                        ...
                        {showRoundGuide && (
                            <div style={{ marginTop: 10, overflowX: "auto" }}>
                                ...
                                <div style={{ marginTop: 6, fontSize: 11, fontStyle: "italic", color: "var(--color-text-tertiary)" }}>
                                    Tip: For seam allowances, round DOWN (not up) — slightly less SA is easier to manage than slightly more.
                                </div>
                            </div>
                        )}
                    </div>
