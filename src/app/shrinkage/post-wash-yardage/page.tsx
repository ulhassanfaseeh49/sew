...
<div className={styles.toolHeader}><span className="category-badge"><Ruler size={14} strokeWidth={1.5} /> Shrinkage #232</span><h1>Post-Wash Yardage Calculator</h1><p>Resulting yardage after washing.</p></div>
