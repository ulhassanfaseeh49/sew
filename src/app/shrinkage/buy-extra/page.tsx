...
<div className={styles.toolHeader}><span className="category-badge"><span>➕</span> Shrinkage #231</span><h1>Buy Extra for Shrinkage</h1><p>How much extra fabric to buy for shrinkage.</p></div>
