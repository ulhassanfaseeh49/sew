...
<div className={styles.toolHeader}><span className="category-badge"><ClipboardCopy size={14} strokeWidth={1.5} /> Shrinkage #234</span><h1>Fabric Shrinkage Database</h1><p>Expected shrinkage by fabric type.</p></div>
