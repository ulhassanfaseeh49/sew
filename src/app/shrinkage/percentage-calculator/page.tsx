...
<div className={styles.toolHeader}><span className="category-badge"><span>📊</span> Shrinkage #233</span><h1>Shrinkage Percentage Calculator</h1><p>Calculate actual shrinkage from before/after measurements.</p></div>
