...
<div className={styles.toolHeader}><span className="category-badge"><span>👗</span> Shrinkage #237</span><h1>Garment Shrinkage Adjuster</h1><p>Pattern size adjustments for expected shrinkage.</p></div>
