...
export default function Page() {
  ...
  const [style, setStyle] = useState("Top/Blouse");
  ...
  const allStyles = ["Top/Blouse","Dress","Skirt","Pants","Jacket","Coat","Vest","Jumpsuit"];
  ...
  return (
    <div className="container">
      <Breadcrumb items={[{label:"Yardage Calculators",href:"/yardage"},{label:"General Garment Yardage Estimator"}]} />
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><span>👗</span> Yardage Tool #35</span>
            <h1>General Garment Yardage Estimator</h1>
            <p>Estimate yardage for any garment by measurements and style.</p>
          </div>
            ...
            <div className="calculator-form">
              <div className="calculator-form-row">
                <div className="input-group"><label className="input-label">Style</label>
                  <select className="input-field" value={style} onChange={e=>setStyle(e.target.value)}><option value="Top/Blouse">Top/Blouse</option><option value="Dress">Dress</option><option value="Skirt">Skirt</option><option value="Pants">Pants</option><option value="Jacket">Jacket</option><option value="Coat">Coat</option><option value="Vest">Vest</option><option value="Jumpsuit">Jumpsuit</option></select></div>
