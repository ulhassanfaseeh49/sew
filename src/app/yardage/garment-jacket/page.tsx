...
export default function Page() {
  ...
  const [style, setStyle] = useState("Blazer");
  ...
  const allStyles = ["Blazer","Bomber","Moto","Denim","Cardigan","Cape"];
  ...
  return (
    <div className="container">
      <Breadcrumb items={[{label:"Yardage Calculators",href:"/yardage"},{label:"Jacket Yardage Calculator"}]} />
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><span>🧥</span> Yardage Tool #40</span>
            <h1>Jacket Yardage Calculator</h1>
            <p>Yardage for jackets with lining options.</p>
          </div>
            ...
            <div className="calculator-form">
              <div className="calculator-form-row">
                <div className="input-group"><label className="input-label">Style</label>
                  <select className="input-field" value={style} onChange={e=>setStyle(e.target.value)}><option value="Blazer">Blazer</option><option value="Bomber">Bomber</option><option value="Moto">Moto</option><option value="Denim">Denim</option><option value="Cardigan">Cardigan</option><option value="Cape">Cape</option></select></div>
