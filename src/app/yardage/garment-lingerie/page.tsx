...
export default function Page() {
  ...
  const [style, setStyle] = useState("Bralette");
  ...
  const allStyles = ["Bralette","Underwear","Slip","Camisole","Robe"];
  ...
  return (
    <div className="container">
      <Breadcrumb items={[{label:"Yardage Calculators",href:"/yardage"},{label:"Lingerie/Underwear Yardage"}]} />
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><span>🩱</span> Yardage Tool #45</span>
            <h1>Lingerie/Underwear Yardage</h1>
            <p>Yardage for bras, panties, slips, camisoles.</p>
          </div>
            ...
            <div className="calculator-form">
              <div className="calculator-form-row">
                <div className="input-group"><label className="input-label">Style</label>
                  <select className="input-field" value={style} onChange={e=>setStyle(e.target.value)}><option value="Bralette">Bralette</option><option value="Underwear">Underwear</option><option value="Slip">Slip</option><option value="Camisole">Camisole</option><option value="Robe">Robe</option></select></div>
