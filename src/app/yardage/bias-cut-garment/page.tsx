...
import { ClipboardCopy, Printer, Ruler, Shield, TrendingUp } from "lucide-react";
      ...
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><TrendingUp size={14} strokeWidth={1.5} /> Yardage Tool</span>
