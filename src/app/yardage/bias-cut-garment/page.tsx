...
export default function Page() {
  ...
  const [style, setStyle] = useState("Bias slip dress");
  ...
  const allStyles = ["Bias slip dress","Bias skirt","Bias top","Bias nightgown"];
  ...
  return (
    <div className="container">
      <Breadcrumb items={[{label:"Yardage Calculators",href:"/yardage"},{label:"Bias-Cut Garment Yardage"}]} />
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><span>↗️</span> Yardage Tool #48</span>
            <h1>Bias-Cut Garment Yardage</h1>
            <p>Extra yardage for bias-cut garments.</p>
          </div>
            ...
            <div className="calculator-form">
              <div className="calculator-form-row">
                <div className="input-group"><label className="input-label">Style</label>
                  <select className="input-field" value={style} onChange={e=>setStyle(e.target.value)}><option value="Bias slip dress">Bias slip dress</option><option value="Bias skirt">Bias skirt</option><option value="Bias top">Bias top</option><option value="Bias nightgown">Bias nightgown</option></select></div>
