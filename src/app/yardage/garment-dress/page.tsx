...
export default function Page() {
  ...
  const [style, setStyle] = useState("Sheath");
  ...
  const allStyles = ["Sheath","A-line","Fit-and-flare","Maxi","Wrap","Shift","Sundress"];
  ...
  return (
    <div className="container">
      <Breadcrumb items={[{label:"Yardage Calculators",href:"/yardage"},{label:"Dress Yardage Calculator"}]} />
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><span>👗</span> Yardage Tool #37</span>
            <h1>Dress Yardage Calculator</h1>
            <p>Yardage for dresses by style and length.</p>
          </div>
            ...
            <div className="calculator-form">
              <div className="calculator-form-row">
                <div className="input-group"><label className="input-label">Style</label>
                  <select className="input-field" value={style} onChange={e=>setStyle(e.target.value)}><option value="Sheath">Sheath</option><option value="A-line">A-line</option><option value="Fit-and-flare">Fit-and-flare</option><option value="Maxi">Maxi</option><option value="Wrap">Wrap</option><option value="Shift">Shift</option><option value="Sundress">Sundress</option></select></div>
