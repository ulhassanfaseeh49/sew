...
export default function Page() {
  ...
  const [style, setStyle] = useState("Petite 5ft0-5ft3");
  ...
  const allStyles = ["Petite 5ft0-5ft3","Very petite under 5ft"];
  ...
  return (
    <div className="container">
      <Breadcrumb items={[{label:"Yardage Calculators",href:"/yardage"},{label:"Petite Yardage Adjuster"}]} />
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><span>📏</span> Yardage Tool #50</span>
            <h1>Petite Yardage Adjuster</h1>
            <p>Adjust yardage for petite sizing.</p>
          </div>
            ...
            <div className="calculator-form">
              <div className="calculator-form-row">
                <div className="input-group"><label className="input-label">Style</label>
                  <select className="input-field" value={style} onChange={e=>setStyle(e.target.value)}><option value="Petite 5ft0-5ft3">Petite 5ft0-5ft3</option><option value="Very petite under 5ft">Very petite under 5ft</option></select></div>
