...
export default function Page() {
  ...
  const [style, setStyle] = useState("Basic fitted");
  ...
  const allStyles = ["Basic fitted","Relaxed","Cropped","Tunic","Peasant","Button-front","Wrap top","Peplum"];
  ...
  return (
    <div className="container">
      <Breadcrumb items={[{label:"Yardage Calculators",href:"/yardage"},{label:"Top/Blouse Yardage Calculator"}]} />
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><span>👚</span> Yardage Tool #36</span>
            <h1>Top/Blouse Yardage Calculator</h1>
            <p>Yardage for tops by style, sleeve, and fit.</p>
          </div>
          <div className={`glass-card ${styles.calculatorCard}`}>
            ...
            <div className="calculator-form">
              <div className="calculator-form-row">
                <div className="input-group"><label className="input-label">Style</label>
                  <select className="input-field" value={style} onChange={e=>setStyle(e.target.value)}><option value="Basic fitted">Basic fitted</option><option value="Relaxed">Relaxed</option><option value="Cropped">Cropped</option><option value="Tunic">Tunic</option><option value="Peasant">Peasant</option><option value="Button-front">Button-front</option><option value="Wrap top">Wrap top</option><option value="Peplum">Peplum</option></select></div>
            ...
            <div className={`calculator-results ${styles.results}`}>
              ...
              <div className="toolbar">
                <button className="btn btn-secondary btn-sm" onClick={()=>navigator.clipboard.writeText(style+" "+size+": "+rounded.toFixed(3)+" yd")}>📋 Copy</button>
