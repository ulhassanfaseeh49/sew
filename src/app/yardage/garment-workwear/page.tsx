...
export default function Page() {
  ...
  const [style, setStyle] = useState("Scrub top");
  ...
  const allStyles = ["Scrub top","Scrub pants","Apron","Chef coat","Lab coat"];
  ...
  return (
    <div className="container">
      <Breadcrumb items={[{label:"Yardage Calculators",href:"/yardage"},{label:"Uniform/Workwear Yardage"}]} />
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><span>👔</span> Yardage Tool #47</span>
            <h1>Uniform/Workwear Yardage</h1>
            <p>Yardage for scrubs, aprons, chef coats.</p>
          </div>
            ...
            <div className="calculator-form">
              <div className="calculator-form-row">
                <div className="input-group"><label className="input-label">Style</label>
                  <select className="input-field" value={style} onChange={e=>setStyle(e.target.value)}><option value="Scrub top">Scrub top</option><option value="Scrub pants">Scrub pants</option><option value="Apron">Apron</option><option value="Chef coat">Chef coat</option><option value="Lab coat">Lab coat</option></select></div>
