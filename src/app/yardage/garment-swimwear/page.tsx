...
export default function Page() {
  ...
  const [style, setStyle] = useState("One-piece");
  ...
  const allStyles = ["One-piece","Bikini top","Bikini bottom","Swim trunks","Rash guard"];
  ...
  return (
    <div className="container">
      <Breadcrumb items={[{label:"Yardage Calculators",href:"/yardage"},{label:"Swimwear Yardage Calculator"}]} />
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><span>👙</span> Yardage Tool #43</span>
            <h1>Swimwear Yardage Calculator</h1>
            <p>Yardage for swimsuits in stretch fabric.</p>
          </div>
            ...
            <div className="calculator-form">
              <div className="calculator-form-row">
                <div className="input-group"><label className="input-label">Style</label>
                  <select className="input-field" value={style} onChange={e=>setStyle(e.target.value)}><option value="One-piece">One-piece</option><option value="Bikini top">Bikini top</option><option value="Bikini bottom">Bikini bottom</option><option value="Swim trunks">Swim trunks</option><option value="Rash guard">Rash guard</option></select></div>
