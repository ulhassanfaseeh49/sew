...
export default function Page() {
  ...
  const [style, setStyle] = useState("Straight leg");
  ...
  const allStyles = ["Straight leg","Wide leg","Palazzo","Skinny","Shorts","Capri","Joggers"];
  ...
  return (
    <div className="container">
      <Breadcrumb items={[{label:"Yardage Calculators",href:"/yardage"},{label:"Pants/Trousers Yardage Calculator"}]} />
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><span>👖</span> Yardage Tool #39</span>
            <h1>Pants/Trousers Yardage Calculator</h1>
            <p>Yardage for pants, shorts, and capris.</p>
          </div>
            ...
            <div className="calculator-form">
              <div className="calculator-form-row">
                <div className="input-group"><label className="input-label">Style</label>
                  <select className="input-field" value={style} onChange={e=>setStyle(e.target.value)}><option value="Straight leg">Straight leg</option><option value="Wide leg">Wide leg</option><option value="Palazzo">Palazzo</option><option value="Skinny">Skinny</option><option value="Shorts">Shorts</option><option value="Capri">Capri</option><option value="Joggers">Joggers</option></select></div>
