...
export default function Page() {
  ...
  const [style, setStyle] = useState("PJ set");
  ...
  const allStyles = ["PJ set","Nightgown","Robe","Shorts set","Sleep shirt"];
  ...
  return (
    <div className="container">
      <Breadcrumb items={[{label:"Yardage Calculators",href:"/yardage"},{label:"Sleepwear/Pajama Yardage"}]} />
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><span>🌙</span> Yardage Tool #46</span>
            <h1>Sleepwear/Pajama Yardage</h1>
            <p>Yardage for pajama sets, nightgowns, robes.</p>
          </div>
            ...
            <div className="calculator-form">
              <div className="calculator-form-row">
                <div className="input-group"><label className="input-label">Style</label>
                  <select className="input-field" value={style} onChange={e=>setStyle(e.target.value)}><option value="PJ set">PJ set</option><option value="Nightgown">Nightgown</option><option value="Robe">Robe</option><option value="Shorts set">Shorts set</option><option value="Sleep shirt">Sleep shirt</option></select></div>
