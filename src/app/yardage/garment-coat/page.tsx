...
export default function Page() {
  ...
  const [style, setStyle] = useState("Overcoat");
  ...
  const allStyles = ["Overcoat","Trench","Peacoat","Cape","Puffer","Duster"];
  ...
  return (
    <div className="container">
      <Breadcrumb items={[{label:"Yardage Calculators",href:"/yardage"},{label:"Coat Yardage Calculator"}]} />
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><span>🧥</span> Yardage Tool #41</span>
            <h1>Coat Yardage Calculator</h1>
            <p>Yardage for coats with lining and interfacing.</p>
          </div>
            ...
            <div className="calculator-form">
              <div className="calculator-form-row">
                <div className="input-group"><label className="input-label">Style</label>
                  <select className="input-field" value={style} onChange={e=>setStyle(e.target.value)}><option value="Overcoat">Overcoat</option><option value="Trench">Trench</option><option value="Peacoat">Peacoat</option><option value="Cape">Cape</option><option value="Puffer">Puffer</option><option value="Duster">Duster</option></select></div>
