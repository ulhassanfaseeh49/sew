...
export default function Page() {
  ...
  const [style, setStyle] = useState("Fitted vest");
  ...
  const allStyles = ["Fitted vest","Loose vest","Quilted vest","Long vest"];
  ...
  return (
    <div className="container">
      <Breadcrumb items={[{label:"Yardage Calculators",href:"/yardage"},{label:"Vest/Waistcoat Yardage Calculator"}]} />
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><span>🦺</span> Yardage Tool #42</span>
            <h1>Vest/Waistcoat Yardage Calculator</h1>
            <p>Yardage for vests with lining options.</p>
          </div>
            ...
            <div className="calculator-form">
              <div className="calculator-form-row">
                <div className="input-group"><label className="input-label">Style</label>
                  <select className="input-field" value={style} onChange={e=>setStyle(e.target.value)}><option value="Fitted vest">Fitted vest</option><option value="Loose vest">Loose vest</option><option value="Quilted vest">Quilted vest</option><option value="Long vest">Long vest</option></select></div>
