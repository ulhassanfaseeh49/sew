...
export default function Page() {
  ...
  const [style, setStyle] = useState("Leggings");
  ...
  const allStyles = ["Leggings","Sports bra","Yoga pants","Athletic shorts","Tank top"];
  ...
  return (
    <div className="container">
      <Breadcrumb items={[{label:"Yardage Calculators",href:"/yardage"},{label:"Activewear/Leggings Yardage"}]} />
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><span>🏃</span> Yardage Tool #44</span>
            <h1>Activewear/Leggings Yardage</h1>
            <p>Yardage for leggings, sports bras, athletic wear.</p>
          </div>
            ...
            <div className="calculator-form">
              <div className="calculator-form-row">
                <div className="input-group"><label className="input-label">Style</label>
                  <select className="input-field" value={style} onChange={e=>setStyle(e.target.value)}><option value="Leggings">Leggings</option><option value="Sports bra">Sports bra</option><option value="Yoga pants">Yoga pants</option><option value="Athletic shorts">Athletic shorts</option><option value="Tank top">Tank top</option></select></div>
