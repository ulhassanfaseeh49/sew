...
export default function Page() {
  ...
  const allStyles = ["Pencil","A-line","Circle","Pleated","Tiered","Maxi","Mini"];
  ...
  return (
    <div className="container">
      <Breadcrumb items={[{label:"Yardage Calculators",href:"/yardage"},{label:"Skirt Yardage Calculator"}]} />
      <div className="calculator-layout">
        <div className="calculator-main">
          <div className={styles.toolHeader}>
            <span className="category-badge"><span>🩱</span> Yardage Tool #38</span>
            <h1>Skirt Yardage Calculator</h1>
            <p>Yardage for skirts by style and fullness.</p>
          </div>
            ...
            <div className="calculator-form">
              <div className="calculator-form-row">
                <div className="input-group"><label className="input-label">Style</label>
                  <select className="input-field" value={style} onChange={e=>setStyle(e.target.value)}><option value="Pencil">Pencil</option><option value="A-line">A-line</option><option value="Circle">Circle</option><option value="Pleated">Pleated</option><option value="Tiered">Tiered</option><option value="Maxi">Maxi</option><option value="Mini">Mini</option></select></div>
