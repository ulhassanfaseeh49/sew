...
<div className={styles.toolHeader}><span className="category-badge"><span>🛏️</span> Home #260</span><h1>Headboard Upholstery</h1><p>Fabric for upholstered headboards.</p></div>
