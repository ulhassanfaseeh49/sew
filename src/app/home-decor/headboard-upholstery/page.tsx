...
const sizes = [{k:"twin",n:"Twin (42x36)",w:42,h:36},{k:"full",n:"Full (57x36)",w:57,h:36},{k:"queen",n:"Queen (63x36)",w:63,h:36},{k:"king",n:"King (79x48)",w:79,h:48}];

export default function Page() {
    const [sizeKey, setSizeKey] = useState(sizes[0].k);
    const [qty, setQty] = useState(1);
    const [activeFaq, setActiveFaq] = useState<number | null>(null);
    const faqItems = [{"q":"What fabric for headboard?","a":"Upholstery-weight (300+ GSM). Velvet, linen, performance poly. Use 2 inch foam + batting."}];
    const spec = sizes.find((s: typeof sizes[0]) => s.k === sizeKey) || sizes[0];
    const wrap=6;const cutW=spec.w+wrap*2;const cutH=spec.h+wrap*2;const yd=Math.ceil(cutW*cutH/(54*36)*4)/4;
    const resultText = `${cutW}" x ${cutH}" (${yd} yd of 54" fabric)`;
    return (<div className="container"><Breadcrumb items={[{ label: "Home Decor", href: "/home-decor" }, { label: "Headboard Upholstery Calculator" }]} />
        <div className="calculator-layout"><div className="calculator-main">
            <div className={styles.toolHeader}><span className="category-badge"><Home size={14} /> Home #447</span><h1>Headboard Upholstery Calculator</h1><p>Calculate fabric for headboard upholstery.</p></div>
