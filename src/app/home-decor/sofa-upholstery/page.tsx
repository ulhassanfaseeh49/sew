...
<div className={styles.toolHeader}><span className="category-badge"><span>🛋️</span> Home #255</span><h1>Sofa Upholstery Yardage</h1><p>Yardage for reupholstering sofas.</p></div>
