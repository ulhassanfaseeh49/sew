...
<div className={styles.toolHeader}><span className="category-badge"><Package size={14} strokeWidth={1.5} /> Home #265</span><h1>Box Cushion Calculator</h1><p>Fabric for box-style cushions.</p></div>
