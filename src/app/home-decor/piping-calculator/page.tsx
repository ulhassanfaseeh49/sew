...
<div className={styles.toolHeader}><span className="category-badge"><span></span> Home #268</span><h1>Piping/Welt Cord Yardage</h1><p>Bias strip and cord for piping.</p></div>
