...
<div className={styles.toolHeader}><span className="category-badge"><span></span> Home #262</span><h1>Cushion Cover (Envelope)</h1><p>Fabric for envelope-back covers.</p></div>
