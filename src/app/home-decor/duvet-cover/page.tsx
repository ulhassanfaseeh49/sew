...
<div className={styles.toolHeader}><span className="category-badge"><Bed size={14} strokeWidth={1.5} /> Home #274</span><h1>Duvet Cover Calculator</h1><p>Fabric for duvet covers.</p></div>
