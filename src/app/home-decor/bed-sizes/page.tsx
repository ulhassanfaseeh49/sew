...
const sizes = [{k:"twin",n:"Twin",w:39,h:75},{k:"txl",n:"Twin XL",w:39,h:80},{k:"full",n:"Full",w:54,h:75},{k:"queen",n:"Queen",w:60,h:80},{k:"king",n:"King",w:76,h:80},{k:"calk",n:"Cal King",w:72,h:84}];

export default function Page() {
    const [sizeKey, setSizeKey] = useState(sizes[0].k);
    
    const [activeFaq, setActiveFaq] = useState<number | null>(null);
    const faqItems = [{"q":"King vs Cal King?","a":"King: 76x80 (wider). Cal King: 72x84 (longer, best for tall people)."}];
    const spec = sizes.find((s: typeof sizes[0]) => s.k === sizeKey) || sizes[0];
    const info=spec.w+'" x '+spec.h+'"';
    const resultText = `${spec.n}: ${spec.w}" x ${spec.h}"`;
    return (<div className="container"><Breadcrumb items={[{ label: "Home Decor", href: "/home-decor" }, { label: "Bed Size Reference" }]} />
        <div className="calculator-layout"><div className="calculator-main">
            <div className={styles.toolHeader}><span className="category-badge"><Home size={14} /> Home #453</span><h1>Bed Size Reference</h1><p>Standard bed dimensions for sewing projects.</p></div>
