...
<div className={styles.toolHeader}><span className="category-badge"><Bed size={14} strokeWidth={1.5} /> Home #278</span><h1>Pillow Sham Calculator</h1><p>Fabric for pillow shams.</p></div>
