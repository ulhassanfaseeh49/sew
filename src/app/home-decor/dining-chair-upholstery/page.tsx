...
import { Armchair, ClipboardCopy, Printer } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Armchair size={14} strokeWidth={1.5} /> Home #257</span><h1>Dining Chair Upholstery</h1><p>Yardage for dining chairs.</p></div>
