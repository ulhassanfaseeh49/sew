...
<div className={styles.toolHeader}><span className="category-badge"><Ruler size={14} strokeWidth={1.5} /> Home #276</span><h1>Fitted Sheet Calculator</h1><p>Fabric for fitted sheets.</p></div>
