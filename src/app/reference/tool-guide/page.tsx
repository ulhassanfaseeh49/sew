...
const items = [{"term":"Rotary Cutter","def":"Round blade. Cuts multiple layers. Use with mat and ruler."},{"term":"Seam Gauge","def":"6 inch ruler with slider. For hems, SA, buttonholes."},{"term":"Tailor Ham","def":"Rounded pressing tool for curved seams and darts."},{"term":"Walking Foot","def":"Even-feed foot. Both layers feed evenly. For quilting, velvet."},{"term":"Chalk/Markers","def":"Tailor chalk: brushes off. Water-soluble pen: disappears."}];

export default function Page() {
    const [search, setSearch] = useState("");
    const [activeFaq, setActiveFaq] = useState<number | null>(null);
    const faqItems = [{"q":"Essential tools?","a":"Start: machine, scissors, pins, tape, iron. Add rotary cutter next (huge upgrade)."}];
    ...
    return (<div className="container"><Breadcrumb items={[{ label: "Reference", href: "/reference" }, { label: "Sewing Tool Guide" }]} />
        <div className="calculator-layout"><div className="calculator-main">
            <div className={styles.toolHeader}><span className="category-badge"><BookOpen size={14} /> Ref #484</span><h1>Sewing Tool Guide</h1><p>Guide to sewing tools.</p></div>
