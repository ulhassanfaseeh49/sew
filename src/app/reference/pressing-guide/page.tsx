...
<div className={styles.toolHeader}><span className="category-badge"><span>♨️</span> Ref #480</span><h1>Pressing vs Ironing</h1><p>The difference between pressing and ironing.</p></div>
