...
const items = [{"term":"Press vs Iron","def":"Press: lift and set down. Iron: slide. PRESS for sewing!"},{"term":"Seams Open","def":"Press SA apart (one each side). Flatter, less bulk."},{"term":"Seams to Side","def":"Both SA to one side. Stronger. For quilting press to dark."},{"term":"Darts","def":"Vertical darts toward center. Bust darts press down. Use ham."},{"term":"Interfacing","def":"Dry iron, medium heat, 10-15 seconds. Use press cloth."}];

export default function Page() {
    const [search, setSearch] = useState("");
    const [activeFaq, setActiveFaq] = useState<number | null>(null);
    const faqItems = [{"q":"Why is pressing important?","a":"Pressing is the #1 difference between homemade and professional results."}];
    ...
    return (<div className="container"><Breadcrumb items={[{ label: "Reference", href: "/reference" }, { label: "Pressing Guide" }]} />
        <div className="calculator-layout"><div className="calculator-main">
            <div className={styles.toolHeader}><span className="category-badge"><BookOpen size={14} /> Ref #479</span><h1>Pressing Guide</h1><p>How to press seams and garment pieces.</p></div>
