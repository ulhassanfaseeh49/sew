...
<div className={styles.toolHeader}><span className="category-badge"><BookOpen size={14} strokeWidth={1.5} /> Ref #462</span><h1>Fabric Encyclopedia</h1><p>Fabric types A-Z.</p></div>
