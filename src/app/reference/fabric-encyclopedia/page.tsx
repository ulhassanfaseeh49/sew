...
const items = [{"term":"Batiste","def":"Lightweight plain-weave. Soft, semi-sheer. For blouses, heirloom sewing."},{"term":"Broadcloth","def":"Smooth plain-weave cotton. Medium weight. For shirts, quilting."},{"term":"Canvas","def":"Heavy plain-weave. Very durable. For bags, upholstery."},{"term":"Chambray","def":"Colored warp + white weft. Lighter than denim. For shirts."},{"term":"Chiffon","def":"Very lightweight sheer. Slippery. For overlays, evening wear."},{"term":"Denim","def":"Twill weave cotton. 4-14 oz. For jeans, jackets, bags."},{"term":"Fleece","def":"Polyester knit, brushed. Does not fray. For jackets, blankets."},{"term":"Jersey","def":"Single knit. Stretchy. Curls at edges. For t-shirts."},{"term":"Lawn","def":"Fine crisp cotton. Lightweight. For summer dresses."},{"term":"Velvet","def":"Pile fabric with nap. For evening wear. Cut all one direction."}];

export default function Page() {
    const [search, setSearch] = useState("");
    const [activeFaq, setActiveFaq] = useState<number | null>(null);
    const faqItems = [{"q":"How to identify unknown fabric?","a":"Check burn test, drape, stretch, and weight. See our Burn Test Guide."}];
    ...
    return (<div className="container"><Breadcrumb items={[{ label: "Reference", href: "/reference" }, { label: "Fabric Encyclopedia" }]} />
        <div className="calculator-layout"><div className="calculator-main">
            <div className={styles.toolHeader}><span className="category-badge"><BookOpen size={14} /> Ref #465</span><h1>Fabric Encyclopedia</h1><p>Guide to fabric types and properties.</p></div>
