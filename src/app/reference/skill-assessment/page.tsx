...
<div className={styles.toolHeader}><span className="category-badge"><span>🎯</span> Ref #475</span><h1>Skill Level Assessment</h1><p>Test your sewing skill level.</p></div>
