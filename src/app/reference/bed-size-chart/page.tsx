...
import { Bed, BookOpen, ClipboardCopy, Printer } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Bed size={14} strokeWidth={1.5} /> Ref #470</span><h1>Bed/Mattress Size Chart</h1><p>Mattress sizes worldwide.</p></div>
