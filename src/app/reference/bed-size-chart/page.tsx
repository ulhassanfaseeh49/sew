...
const items = [{"term":"Twin","def":"39 x 75 inches"},{"term":"Twin XL","def":"39 x 80 inches"},{"term":"Full","def":"54 x 75 inches"},{"term":"Queen","def":"60 x 80 inches"},{"term":"King","def":"76 x 80 inches"},{"term":"Cal King","def":"72 x 84 inches"},{"term":"Crib","def":"28 x 52 inches"}];

export default function Page() {
    const [search, setSearch] = useState("");
    const [activeFaq, setActiveFaq] = useState<number | null>(null);
    const faqItems = [{"q":"Standard mattress depth?","a":"Standard: 8-12 inches. Pillow-top: 12-16. Deep: 16-22. Always measure yours."}];
    ...
    return (<div className="container"><Breadcrumb items={[{ label: "Reference", href: "/reference" }, { label: "Bed Size Chart" }]} />
        <div className="calculator-layout"><div className="calculator-main">
            <div className={styles.toolHeader}><span className="category-badge"><BookOpen size={14} /> Ref #471</span><h1>Bed Size Chart</h1><p>Standard mattress dimensions.</p></div>
