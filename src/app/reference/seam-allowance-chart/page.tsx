...
<div className={styles.toolHeader}><span className="category-badge"><Ruler size={14} strokeWidth={1.5} /> Ref #467</span><h1>Seam Allowance Chart</h1><p>Standard seam allowances.</p></div>
