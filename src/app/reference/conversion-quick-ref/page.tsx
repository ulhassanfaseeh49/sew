...
<div className={styles.toolHeader}><span className="category-badge"><span>📋</span> Ref #466</span><h1>Conversion Quick Reference</h1><p>All-in-one measurement conversions.</p></div>
