...
<div className={styles.toolHeader}><span className="category-badge"><Shirt size={14} strokeWidth={1.5} /> Ref #469</span><h1>Clothing Size Charts</h1><p>US/UK/EU sizing.</p></div>
