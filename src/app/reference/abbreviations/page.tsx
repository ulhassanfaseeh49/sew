...
const items = [{"term":"SA","def":"Seam Allowance"},{"term":"RST","def":"Right Sides Together"},{"term":"WST","def":"Wrong Sides Together"},{"term":"WOF","def":"Width of Fabric"},{"term":"FQ","def":"Fat Quarter (18x22 inches)"},{"term":"HST","def":"Half Square Triangle"},{"term":"FPP","def":"Foundation Paper Piecing"},{"term":"UFO","def":"UnFinished Object"},{"term":"WIP","def":"Work in Progress"},{"term":"TNT","def":"Tried and True (favorite pattern)"},{"term":"CB","def":"Center Back"},{"term":"CF","def":"Center Front"},{"term":"SS","def":"Side Seam"},{"term":"BL","def":"Bust Line"},{"term":"WL","def":"Waist Line"}];

export default function Page() {
    const [search, setSearch] = useState("");
    const [activeFaq, setActiveFaq] = useState<number | null>(null);
    const faqItems = [{"q":"What does UFO mean in sewing?","a":"UnFinished Object. A project started but not completed. Every sewist has a few!"}];
    ...
    return (<div className="container"><Breadcrumb items={[{ label: "Reference", href: "/reference" }, { label: "Sewing Abbreviations" }]} />
        <div className="calculator-layout"><div className="calculator-main">
            <div className={styles.toolHeader}><span className="category-badge"><BookOpen size={14} /> Ref #462</span><h1>Sewing Abbreviations</h1><p>Common sewing abbreviations decoded.</p></div>
