...
<div className={styles.toolHeader}><span className="category-badge"><Bed size={14} strokeWidth={1.5} /> Ref #468</span><h1>Quilt Size Chart</h1><p>Standard quilt sizes.</p></div>
