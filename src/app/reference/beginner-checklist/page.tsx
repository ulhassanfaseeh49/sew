...
<div className={styles.toolHeader}><span className="category-badge"><span>✅</span> Ref #474</span><h1>Beginner Sewing Checklist</h1><p>Essential supplies for beginners.</p></div>
