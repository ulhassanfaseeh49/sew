...
const items = [{"term":"Pre-wash","def":"Wash/dry same way as finished item. Cotton shrinks 3-5%."},{"term":"Check grain","def":"Pull a thread across width. If off-grain, pull diagonally."},{"term":"Press smooth","def":"Iron entire piece wrinkle-free before cutting."},{"term":"Fold correctly","def":"Selvage to selvage, smooth and on-grain."},{"term":"Layout","def":"Place pieces following grain lines. Check for nap direction."}];

export default function Page() {
    const [search, setSearch] = useState("");
    const [activeFaq, setActiveFaq] = useState<number | null>(null);
    const faqItems = [{"q":"Always pre-wash?","a":"Yes for garments. Opinions vary for quilting. Recommended for bags and home dec."}];
    ...
    return (<div className="container"><Breadcrumb items={[{ label: "Reference", href: "/reference" }, { label: "Fabric Preparation Guide" }]} />
        <div className="calculator-layout"><div className="calculator-main">
            <div className={styles.toolHeader}><span className="category-badge"><BookOpen size={14} /> Ref #480</span><h1>Fabric Preparation Guide</h1><p>How to prepare fabric before cutting.</p></div>
