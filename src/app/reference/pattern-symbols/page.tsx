...
const items = [{"term":"Grain Line Arrow","def":"Must be parallel to selvage when placing pattern on fabric."},{"term":"Fold Line","def":"Place this edge on fabric fold. Do not cut along this line."},{"term":"Notch Triangle","def":"Alignment mark. Match notches on pieces when sewing together."},{"term":"Dot/Circle","def":"Pivot point, dart end, or placement mark."},{"term":"Cutting Line (solid)","def":"Outermost line. Cut on this line for your size."},{"term":"Stitching Line (dashed)","def":"Shows where to sew. Usually 5/8 inch inside cutting line."},{"term":"Lengthen/Shorten Line","def":"Where to add or remove length for fit."},{"term":"Dart Lines","def":"V-shaped lines meeting at a point. Fold and sew for shaping."},{"term":"Button/Buttonhole","def":"Circle = button placement. Line = buttonhole position."}];

export default function Page() {
    const [search, setSearch] = useState("");
    const [activeFaq, setActiveFaq] = useState<number | null>(null);
    const faqItems = [{"q":"Cut on thick or thin line?","a":"Cut on the outermost solid line for your size. Inner dashed line is the stitching line."}];
    ...
    return (<div className="container"><Breadcrumb items={[{ label: "Reference", href: "/reference" }, { label: "Pattern Symbol Guide" }]} />
        <div className="calculator-layout"><div className="calculator-main">
            <div className={styles.toolHeader}><span className="category-badge"><BookOpen size={14} /> Ref #464</span><h1>Pattern Symbol Guide</h1><p>Guide to marks on sewing patterns.</p></div>
