...
const items = [{"term":"4-seat round","def":"36-44 inches diameter"},{"term":"6-seat round","def":"48-54 inches"},{"term":"4-seat rectangle","def":"36 x 48 inches"},{"term":"6-seat rectangle","def":"36 x 72 inches"},{"term":"8-seat rectangle","def":"36 x 96 inches"},{"term":"Coffee table","def":"24 x 48 inches typical"}];

export default function Page() {
    const [search, setSearch] = useState("");
    const [activeFaq, setActiveFaq] = useState<number | null>(null);
    const faqItems = [{"q":"Tablecloth overhang?","a":"Casual: 6-8 inches. Formal: 10-15 inches. Floor-length: measure to floor."}];
    ...
    return (<div className="container"><Breadcrumb items={[{ label: "Reference", href: "/reference" }, { label: "Table Size Chart" }]} />
        <div className="calculator-layout"><div className="calculator-main">
            <div className={styles.toolHeader}><span className="category-badge"><BookOpen size={14} /> Ref #472</span><h1>Table Size Chart</h1><p>Standard table dimensions.</p></div>
