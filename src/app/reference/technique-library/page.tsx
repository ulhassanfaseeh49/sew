...
const items = [{"term":"Stay Stitch","def":"1/8 inch inside seamline on curves. Prevents stretching."},{"term":"Understitch","def":"Stitch SA to facing. Prevents facing from rolling out."},{"term":"Edge Stitch","def":"Topstitch very close to edge (1/16 inch)."},{"term":"Clip Curves","def":"Small cuts in SA on curves. Inward: clip. Outward: notch."},{"term":"Grade Seams","def":"Trim each SA to different width. Reduces bulk."},{"term":"Ease Stitch","def":"Longer stitch to gently gather (sleeve caps)."}];

export default function Page() {
    const [search, setSearch] = useState("");
    const [activeFaq, setActiveFaq] = useState<number | null>(null);
    const faqItems = [{"q":"Most important beginner technique?","a":"Pressing! It transforms work from beginner to professional looking."}];
    ...
    return (<div className="container"><Breadcrumb items={[{ label: "Reference", href: "/reference" }, { label: "Technique Library" }]} />
        <div className="calculator-layout"><div className="calculator-main">
            <div className={styles.toolHeader}><span className="category-badge"><BookOpen size={14} /> Ref #483</span><h1>Technique Library</h1><p>Index of sewing techniques.</p></div>
