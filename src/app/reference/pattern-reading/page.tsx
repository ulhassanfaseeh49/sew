...
const items = [{"term":"Envelope Front","def":"Size range, photo, fabric suggestions, yardage chart."},{"term":"Envelope Back","def":"Detailed yardage, notions needed, body measurements."},{"term":"Guide Sheet","def":"Step-by-step instructions. Read ALL before starting!"},{"term":"Size Selection","def":"Use body measurements, not store size. Compare to pattern chart."},{"term":"Layout Diagram","def":"Shows arrangement on fabric. Follow exactly for minimum waste."}];

export default function Page() {
    const [search, setSearch] = useState("");
    const [activeFaq, setActiveFaq] = useState<number | null>(null);
    const faqItems = [{"q":"Which size to use?","a":"Measure bust, waist, hip. Compare to pattern body chart. If between, go up."}];
    ...
    return (<div className="container"><Breadcrumb items={[{ label: "Reference", href: "/reference" }, { label: "Pattern Reading Guide" }]} />
        <div className="calculator-layout"><div className="calculator-main">
            <div className={styles.toolHeader}><span className="category-badge"><BookOpen size={14} /> Ref #481</span><h1>Pattern Reading Guide</h1><p>How to read sewing patterns.</p></div>
