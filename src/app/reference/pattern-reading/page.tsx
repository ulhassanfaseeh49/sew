...
import { BookOpen, ClipboardCopy, FileText, Printer } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><FileText size={14} strokeWidth={1.5} /> Ref #478</span><h1>Pattern Reading Tutorial</h1><p>How to read sewing patterns.</p></div>
