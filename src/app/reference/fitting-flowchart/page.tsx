...
const items = [{"term":"Pulling at bust","def":"Full bust adjustment needed. Add width at side seam."},{"term":"Gaping armhole","def":"Armhole too large. Take in side seam or add shoulder pad."},{"term":"Riding up back","def":"Swayback adjustment. Remove excess at center back waist."},{"term":"Tight at hips","def":"Let out side seams or do full hip adjustment."},{"term":"Waist too high/low","def":"Lengthen/shorten at waist adjustment line."}];

export default function Page() {
    const [search, setSearch] = useState("");
    const [activeFaq, setActiveFaq] = useState<number | null>(null);
    const faqItems = [{"q":"When to make a muslin?","a":"Always for new patterns, especially fitted garments. Test with cheap fabric first."}];
    ...
    return (<div className="container"><Breadcrumb items={[{ label: "Reference", href: "/reference" }, { label: "Fitting Troubleshooting" }]} />
        <div className="calculator-layout"><div className="calculator-main">
            <div className={styles.toolHeader}><span className="category-badge"><BookOpen size={14} /> Ref #482</span><h1>Fitting Troubleshooting</h1><p>Diagnose and fix fit problems.</p></div>
