...
const items = [{"term":"Standard","def":"20 x 26 inches"},{"term":"Queen","def":"20 x 30 inches"},{"term":"King","def":"20 x 36 inches"},{"term":"Euro Sham","def":"26 x 26 inches"},{"term":"Throw (small)","def":"14x14 or 16x16"},{"term":"Throw (large)","def":"18x18 or 20x20"},{"term":"Lumbar","def":"12x20 or 14x24"},{"term":"Bolster","def":"6x16 to 10x30"}];

export default function Page() {
    const [search, setSearch] = useState("");
    const [activeFaq, setActiveFaq] = useState<number | null>(null);
    const faqItems = [{"q":"Insert size for covers?","a":"Use insert 2 inches larger than cover for a plump look."}];
    ...
    return (<div className="container"><Breadcrumb items={[{ label: "Reference", href: "/reference" }, { label: "Pillow Size Chart" }]} />
        <div className="calculator-layout"><div className="calculator-main">
            <div className={styles.toolHeader}><span className="category-badge"><BookOpen size={14} /> Ref #470</span><h1>Pillow Size Chart</h1><p>Standard pillow sizes.</p></div>
