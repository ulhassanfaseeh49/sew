...
<div className={styles.toolHeader}><span className="category-badge"><span></span> Ref #473</span><h1>Pillow Size Reference</h1><p>Standard pillow and cushion sizes.</p></div>
