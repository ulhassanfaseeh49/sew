...
<div className={styles.toolHeader}><span className="category-badge"><span>📊</span> Ref #476</span><h1>Project Difficulty Guide</h1><p>Difficulty ratings for projects.</p></div>
