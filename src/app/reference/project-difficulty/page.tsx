...
const items = [{"term":"Pillowcase (1 star)","def":"Beginner. 1 rectangle, 2 seams, 1 hem. 30 minutes."},{"term":"Tote Bag (2 stars)","def":"Beginner. Rectangles, straps, optional pocket. 1-2 hours."},{"term":"A-line Dress (3 stars)","def":"Intermediate. Bodice fitting, zipper, facing."},{"term":"Quilted Blanket (3 stars)","def":"Intermediate. Precision cutting, many seams, binding."},{"term":"Lined Jacket (4 stars)","def":"Advanced Intermediate. Set-in sleeves, lining, interfacing."},{"term":"Wedding Gown (5 stars)","def":"Expert. Fitting, delicate fabrics, complex construction."}];

export default function Page() {
    const [search, setSearch] = useState("");
    const [activeFaq, setActiveFaq] = useState<number | null>(null);
    const faqItems = [{"q":"Best first project?","a":"Pillowcase! It teaches cutting straight, sewing lines, and hemming."}];
    ...
    return (<div className="container"><Breadcrumb items={[{ label: "Reference", href: "/reference" }, { label: "Project Difficulty Guide" }]} />
        <div className="calculator-layout"><div className="calculator-main">
            <div className={styles.toolHeader}><span className="category-badge"><BookOpen size={14} /> Ref #476</span><h1>Project Difficulty Guide</h1><p>Difficulty ratings for common projects.</p></div>
