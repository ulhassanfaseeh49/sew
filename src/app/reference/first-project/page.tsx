...
const items = [{"term":"Step 1: Choose fabric","def":"Pre-washed 100% cotton. Solid color or small print."},{"term":"Step 2: Gather tools","def":"Machine, thread, scissors, pins, ruler, iron."},{"term":"Step 3: Cut fabric","def":"Measure twice, cut once. Use rotary cutter for straight lines."},{"term":"Step 4: Pin pieces","def":"RST (right sides together). Pin every 3-4 inches."},{"term":"Step 5: Sew straight","def":"Use presser foot edge as guide. Backstitch at start and end."},{"term":"Step 6: Press seams","def":"Press to set stitches, then open or to one side."},{"term":"Step 7: Finish","def":"Trim threads, press final project, admire your work!"}];

export default function Page() {
    const [search, setSearch] = useState("");
    const [activeFaq, setActiveFaq] = useState<number | null>(null);
    const faqItems = [{"q":"What if stitches are crooked?","a":"Go slower, watch fabric edge against presser foot. Practice on scraps first."}];
    ...
    return (<div className="container"><Breadcrumb items={[{ label: "Reference", href: "/reference" }, { label: "First Project Guide" }]} />
        <div className="calculator-layout"><div className="calculator-main">
            <div className={styles.toolHeader}><span className="category-badge"><BookOpen size={14} /> Ref #478</span><h1>First Project Guide</h1><p>Step-by-step for your first sewing project.</p></div>
