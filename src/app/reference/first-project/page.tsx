...
<div className={styles.toolHeader}><span className="category-badge"><span>🌟</span> Ref #477</span><h1>First Project Recommender</h1><p>Your first sewing project.</p></div>
