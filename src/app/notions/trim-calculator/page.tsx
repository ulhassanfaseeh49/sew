...
<div className={styles.toolHeader}><span className="category-badge"><span>✨</span> Notion #195</span><h1>Trim Yardage Calculator</h1><p>Yardage for any trim type.</p></div>
