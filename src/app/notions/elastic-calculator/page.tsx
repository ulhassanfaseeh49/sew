...
<div className={styles.toolHeader}><span className="category-badge"><span>〰️</span> Notion #192</span><h1>Elastic Calculator</h1><p>Elastic length and width by application.</p></div>
