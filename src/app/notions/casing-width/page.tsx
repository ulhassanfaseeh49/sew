...
<div className={styles.toolHeader}><span className="category-badge"><span>📏</span> Notion #199</span><h1>Elastic Casing Width</h1><p>Casing width from elastic width.</p></div>
