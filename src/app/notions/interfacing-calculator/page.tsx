...
<div className={styles.toolHeader}><span className="category-badge"><span>📐</span> Notion #196</span><h1>Interfacing Calculator</h1><p>Select interfacing type and calculate yardage.</p></div>
