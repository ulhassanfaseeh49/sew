...
<div className={styles.toolHeader}><span className="category-badge"><Ruler size={14} strokeWidth={1.5} /> Notion #187</span><h1>Button Spacing Calculator</h1><p>Calculate even button spacing.</p></div>
