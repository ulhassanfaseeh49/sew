...
<div className={styles.toolHeader}><span className="category-badge"><span>🔄</span> Notion #181</span><h1>Bobbin Thread Calculator</h1><p>Calculate bobbins needed for a project.</p></div>
