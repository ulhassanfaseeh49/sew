...
<div className={styles.toolHeader}><span className="category-badge"><ClipboardCopy size={14} strokeWidth={1.5} /> Notion #184</span><h1>Thread Type by Fabric</h1><p>Match thread types to fabric types.</p></div>
