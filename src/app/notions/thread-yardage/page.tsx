...
<div className={styles.toolHeader}><span className="category-badge"><span>🧵</span> Notion #180</span><h1>Thread Yardage Estimator</h1><p>Estimate thread needed for a project.</p></div>
