...
<div className={styles.toolHeader}><span className="category-badge"><span>🎀</span> Notion #193</span><h1>Ribbon Length Calculator</h1><p>Ribbon needed for projects.</p></div>
