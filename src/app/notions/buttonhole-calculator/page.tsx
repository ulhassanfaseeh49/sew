...
<div className={styles.toolHeader}><span className="category-badge"><span></span> Notion #188</span><h1>Buttonhole Length Calculator</h1><p>Buttonhole length from button size.</p></div>
