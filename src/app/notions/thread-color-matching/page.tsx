...
<div className={styles.toolHeader}><span className="category-badge"><span>🎨</span> Notion #183</span><h1>Thread Color Matching Guide</h1><p>Guide for choosing thread color.</p></div>
