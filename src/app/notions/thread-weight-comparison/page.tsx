...
<div className={styles.toolHeader}><span className="category-badge"><span>⚖️</span> Notion #182</span><h1>Thread Weight Comparison</h1><p>Compare thread weights and recommendations.</p></div>
