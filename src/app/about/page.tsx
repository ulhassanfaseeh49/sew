        ...
        <div className="container" style={{ paddingBottom: "5rem" }}>
            ...
            <div style={{ maxWidth: "720px", margin: "0 auto" }}>
                ...
                <div className="glass-card" style={{ padding: "2.5rem" }}>
                    <h2 style={{ fontSize: "1.25rem", marginBottom: "1rem" }}><Scissors size={13} /> Our Mission</h2>
                    ...
                    <h2 style={{ fontSize: "1.25rem", marginBottom: "1rem" }}><Sparkles size={13} /> Why We Built This</h2>
                    <p style={{ lineHeight: 1.8, marginBottom: "1.5rem" }}>
                    ...
                    <h2 style={{ fontSize: "1.25rem", marginBottom: "1rem" }}><Target size={13} /> Our Principles</h2>
