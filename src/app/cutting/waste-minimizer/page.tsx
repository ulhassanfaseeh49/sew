...
<div className={styles.toolHeader}><span className="category-badge"><span>♻️</span> Cutting #175</span><h1>Waste Minimization Planner</h1><p>Optimize cutting to minimize waste.</p></div>
