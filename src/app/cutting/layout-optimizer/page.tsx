...
<div className={styles.toolHeader}><span className="category-badge"><span>📐</span> Cutting #176</span><h1>Cutting Layout Optimizer</h1><p>Optimal arrangement of pattern pieces.</p></div>
