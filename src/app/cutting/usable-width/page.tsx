...
<div className={styles.toolHeader}><span className="category-badge"><span>📏</span> Cutting #178</span><h1>Usable Width Calculator</h1><p>Actual usable width after selvage.</p></div>
