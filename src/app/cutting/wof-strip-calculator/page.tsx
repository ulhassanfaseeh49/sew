...
<div className={styles.toolHeader}><span className="category-badge"><span>↔️</span> Cutting #172</span><h1>WOF Strip Calculator</h1><p>Strips cut along width of fabric.</p></div>
