...
import { ClipboardCopy, Printer, Scissors, TrendingUp } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><TrendingUp size={14} strokeWidth={1.5} /> Cutting #171</span><h1>Bias Strip Calculator</h1><p>Bias strips at 45° and total yield.</p></div>
