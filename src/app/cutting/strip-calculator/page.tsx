...
<div className={styles.toolHeader}><span className="category-badge"><span>📏</span> Cutting #167</span><h1>Strip Cutting Calculator</h1><p>How many strips from a yard of fabric.</p></div>
