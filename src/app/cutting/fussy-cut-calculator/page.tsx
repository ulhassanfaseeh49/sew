...
<div className={styles.toolHeader}><span className="category-badge"><span>🎯</span> Cutting #179</span><h1>Fussy Cut Calculator</h1><p>Yardage for fussy cutting specific motifs.</p></div>
