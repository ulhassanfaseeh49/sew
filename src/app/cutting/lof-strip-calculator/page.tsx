...
<div className={styles.toolHeader}><span className="category-badge"><span>↕️</span> Cutting #173</span><h1>LOF Strip Calculator</h1><p>Strips cut along length of fabric.</p></div>
