...
<div className={styles.toolHeader}><span className="category-badge"><DollarSign size={14} strokeWidth={1.5} /> Pricing #400</span><h1>Handmade Item Pricing</h1><p>Calculate selling price for handmade items.</p></div>
