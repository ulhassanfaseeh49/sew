...
<div className={styles.toolHeader}><span className="category-badge"><span>📊</span> Pricing #401</span><h1>Cost-Plus Pricing</h1><p>Price with adjustable profit margin.</p></div>
