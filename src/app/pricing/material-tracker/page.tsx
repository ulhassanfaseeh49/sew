...
<div className={styles.toolHeader}><span className="category-badge"><ClipboardCopy size={14} strokeWidth={1.5} /> Pricing #403</span><h1>Material Cost Tracker</h1><p>Track material costs per project.</p></div>
