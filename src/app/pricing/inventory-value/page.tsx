...
<div className={styles.toolHeader}><span className="category-badge"><Package size={14} strokeWidth={1.5} /> Pricing #414</span><h1>Inventory Value</h1><p>Calculate inventory value.</p></div>
