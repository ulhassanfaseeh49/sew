...
import { ClipboardCopy, DollarSign, Printer, Store } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Store size={14} strokeWidth={1.5} /> Pricing #404</span><h1>Etsy Fee Calculator</h1><p>Calculate Etsy fees and profit.</p></div>
