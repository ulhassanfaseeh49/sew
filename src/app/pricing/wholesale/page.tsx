...
import { ClipboardCopy, DollarSign, Package, Printer } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Package size={14} strokeWidth={1.5} /> Pricing #406</span><h1>Wholesale Pricing</h1><p>Wholesale price calculator.</p></div>
