...
<div className={styles.toolHeader}><span className="category-badge"><span>⚖️</span> Pricing #408</span><h1>Break-Even Calculator</h1><p>Units to break even on costs.</p></div>
