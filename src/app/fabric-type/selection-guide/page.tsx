...
import { BookOpen, ClipboardCopy, Printer, Scale } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><BookOpen size={14} strokeWidth={1.5} /> Fabric #418</span><h1>Fabric Selection Guide</h1><p>Find fabric for your project.</p></div>
