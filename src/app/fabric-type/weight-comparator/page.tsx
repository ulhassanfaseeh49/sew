...
<div className={styles.toolHeader}><span className="category-badge"><span>📊</span> Fabric #417</span><h1>Fabric Weight Comparator</h1><p>Compare fabric weights by category.</p></div>
