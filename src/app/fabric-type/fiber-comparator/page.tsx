...
import { ClipboardCopy, Leaf, Printer, Scale } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Leaf size={14} strokeWidth={1.5} /> Fabric #422</span><h1>Natural vs Synthetic</h1><p>Compare fiber types.</p></div>
