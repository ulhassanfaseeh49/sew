...
<div className={styles.toolHeader}><span className="category-badge"><ClipboardCopy size={14} strokeWidth={1.5} /> Fabric #420</span><h1>Property Comparator</h1><p>Compare fabric properties.</p></div>
