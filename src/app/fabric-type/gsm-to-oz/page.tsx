...
<div className={styles.toolHeader}><span className="category-badge"><Scale size={14} strokeWidth={1.5} /> Fabric #415</span><h1>GSM to oz/yd² Converter</h1><p>Convert GSM to ounces per square yard.</p></div>
