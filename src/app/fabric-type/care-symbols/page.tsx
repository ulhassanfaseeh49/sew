...
import { ClipboardCopy, Printer, Scale, Tag } from "lucide-react";
...
<div className={styles.toolHeader}><span className="category-badge"><Tag size={14} strokeWidth={1.5} /> Fabric #419</span><h1>Care Symbol Database</h1><p>Fabric care symbols guide.</p></div>
