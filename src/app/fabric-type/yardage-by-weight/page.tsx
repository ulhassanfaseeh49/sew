...
<div className={styles.toolHeader}><span className="category-badge"><span>⚖️</span> Fabric #427</span><h1>Yardage by Weight</h1><p>Calculate yardage from fabric weight.</p></div>
