...
export const yardageTools: YardageTool[] = [
    ...
    { id: 53, name: "Quilt Batting Size", slug: "quilt-batting", description: "Batting size with overhang vs standard sizes", icon: "", subcategory: "Quilt Yardage" },
    ...
    { id: 55, name: "Pillow/Cushion Yardage", slug: "pillows", description: "Yardage for throw pillows of any size", icon: "", subcategory: "Home Décor Yardage" },
    { id: 56, name: "Tablecloth Yardage", slug: "tablecloth", description: "Yardage for tablecloths by table size and drop", icon: "", subcategory: "Home Décor Yardage" },
    { id: 57, name: "Bed Sheet Yardage", slug: "bed-sheets", description: "Yardage for fitted and flat sheets any mattress", icon: "", subcategory: "Home Décor Yardage" },
