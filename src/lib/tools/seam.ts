...
export const seamTools: SeamTool[] = [
    { id: 83, name: "Seam Allowance Converter", slug: "converter", description: "Convert between common seam allowances in imperial and metric", icon: "↔️" },
    ...
    { id: 92, name: "Curved Seams Guide", slug: "curved-seams", description: "Guide for grading/clipping seam allowances on curves", icon: "〰️" },
    { id: 93, name: "Seam Finish Comparison", slug: "finish-comparison", description: "Compare all seam finish types side by side", icon: "⚖️" },
