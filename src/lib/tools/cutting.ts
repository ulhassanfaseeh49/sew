...
export const cuttingTools: CuttingTool[] = [
    ...
    { id: 171, name: "Bias Strip Calculator", slug: "bias-strip-calculator", description: "Bias strips at 45° and total yield", icon: "" },
    { id: 172, name: "WOF Strip Calculator", slug: "wof-strip-calculator", description: "Strips cut along width of fabric", icon: "" },
    { id: 173, name: "LOF Strip Calculator", slug: "lof-strip-calculator", description: "Strips cut along length of fabric", icon: "" },
    { id: 174, name: "Sub-Cut Calculator", slug: "sub-cut-calculator", description: "Sub-cuts from strips into smaller pieces", icon: "" },
    { id: 175, name: "Waste Minimization Planner", slug: "waste-minimizer", description: "Optimize cutting layout to minimize waste", icon: "" },
