...
export const biasBindingTools: BiasBindingTool[] = [
    ...
    { id: 284, name: "Single vs Double Fold", slug: "fold-comparator", description: "Compare fold types", icon: "" },
    ...
    { id: 289, name: "Piping from Bias Tape", slug: "piping-from-bias", description: "Bias tape width for piping cord", icon: "" },
];
