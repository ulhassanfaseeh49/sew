...
export const elasticTools: ElasticTool[] = [
    { id: 290, name: "Waist Elastic Calculator", slug: "waist-calculator", description: "Elastic length for waistbands", icon: "" },
...
export const stretchTools: StretchTool[] = [
    ...
    { id: 303, name: "Knit Type Comparator", slug: "knit-type-comparator", description: "Jersey vs interlock vs rib", icon: "" },
    ...
    { id: 306, name: "Differential Feed Calculator", slug: "differential-feed", description: "Serger settings for knits", icon: "" },
    { id: 307, name: "Recovery & Stretch Ratio", slug: "recovery-ratio", description: "Stretch-to-recovery ratio", icon: "" },
    { id: 308, name: "Two-Way vs Four-Way Stretch", slug: "stretch-direction-guide", description: "Compare stretch directions", icon: "" },
];
...
export const embroideryTools: EmbroideryTool[] = [
    ...
    { id: 318, name: "Appliqué Fabric Yardage", slug: "applique-yardage", description: "Fabric for appliqué pieces", icon: "" },
