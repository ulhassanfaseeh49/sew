...
export const costTools: CostTool[] = [
    ...
    { id: 73, name: "Handmade Item Pricing", slug: "pricing-calculator", description: "Selling price: materials + labor + overhead + profit margin", icon: "🏷️" },
    { id: 74, name: "Fabric Comparison Tool", slug: "fabric-comparison", description: "Compare costs of different fabrics for the same project", icon: "⚖️" },
