...
export const babyKidsTools: BabyKidsTool[] = [
    ...
    { id: 397, name: "Crib Sheet Calculator", slug: "crib-sheet", description: "Fitted crib sheets", icon: "" },
...
export const pricingTools: PricingTool[] = [
    ...
    { id: 408, name: "Break-Even Calculator", slug: "break-even", description: "Units to break even", icon: "" },
    { id: 409, name: "Pricing Comparison", slug: "comparison", description: "Compare pricing strategies", icon: "" },
    { id: 410, name: "Time Tracking", slug: "time-tracker", description: "Track sewing project time", icon: "⏱" },
