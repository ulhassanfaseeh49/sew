...
export const patternTools: PatternTool[] = [
    ...
    { id: 112, name: "Seam to Cutting Line Converter", slug: "seam-to-cutting-converter", description: "Convert between European seam line and American cutting line patterns", icon: "" },
];
