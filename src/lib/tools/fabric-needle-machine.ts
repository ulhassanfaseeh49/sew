...
export const fabricTypeTools: FabricTypeTool[] = [
    { id: 415, name: "GSM to oz/yd² Converter", slug: "gsm-to-oz", description: "Convert GSM to oz/yd²", icon: "" },
    { id: 416, name: "oz/yd² to GSM Converter", slug: "oz-to-gsm", description: "Convert oz/yd² to GSM", icon: "" },
    ...
    { id: 419, name: "Care Symbol Database", slug: "care-symbols", description: "Fabric care symbols guide", icon: "" },
    ...
    { id: 427, name: "Yardage by Weight", slug: "yardage-by-weight", description: "Calculate yardage from weight", icon: "" },
];
...
export const needleThreadTools: NeedleThreadTool[] = [
    ...
    { id: 435, name: "Serger Needle Guide", slug: "serger-needle-guide", description: "Serger needle selection", icon: "" },
...
export const machineTools: MachineTool[] = [
    ...
    { id: 439, name: "Stitch Width Guide", slug: "stitch-width", description: "Width for zigzag/decorative", icon: "" },
    { id: 440, name: "SPI Calculator", slug: "spi-calculator", description: "Stitches per inch converter", icon: "" },
    { id: 441, name: "Tension Guide", slug: "tension-guide", description: "Tension settings by fabric", icon: "" },
    { id: 442, name: "Presser Foot Guide", slug: "presser-foot-guide", description: "Which foot to use", icon: "" },
    { id: 443, name: "Speed Estimator", slug: "speed-estimator", description: "Estimate sewing speed", icon: "⏱" },
    ...
    { id: 448, name: "Serger Settings Guide", slug: "serger-guide", description: "Serger settings by fabric", icon: "" },
