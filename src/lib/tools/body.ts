...
export const bodyTools: BodyTool[] = [
    ...
    { id: 122, name: "Brand Size Comparator", slug: "brand-size-comparator", description: "Compare sizing between pattern brands", icon: "" },
    { id: 123, name: "Alterations Calculator", slug: "alterations-calculator", description: "Compare measurements to pattern and list needed alterations", icon: "" },
