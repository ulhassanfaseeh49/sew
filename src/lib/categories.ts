...
export const categories: Category[] = [
    ...
    { id: 13, name: "Upholstery & Home Décor", slug: "home-decor", icon: "", toolCount: 25, description: "Cushions, tablecloths, bedding, and upholstery" },
    ...
    { id: 15, name: "Elastic & Waistband Tools", slug: "elastic", icon: "", toolCount: 9, description: "Calculate elastic lengths and waistband dimensions" },
    ...
    { id: 23, name: "Pricing & Selling Tools", slug: "pricing", icon: "", toolCount: 15, description: "Price handmade items, calculate profits and fees" },
    { id: 24, name: "Fabric Weight & Type", slug: "fabric-type", icon: "", toolCount: 13, description: "GSM converters, fabric guides, and comparators" },
    ...
    { id: 27, name: "Sustainable & Zero Waste", slug: "sustainable", icon: "", toolCount: 11, description: "Reduce waste, upcycle, and sew sustainably" },
